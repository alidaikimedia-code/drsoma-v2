...
export default function OtoplastyMalaysia() {
  ...
  const faqs = [
    { question: "What is otoplasty?", answer: "Otoplasty is surgery to reshape or reposition the ears for better facial balance." },
    { question: "Is ear pinning surgery painful?", answer: "Discomfort is usually mild and well controlled with medication." },
    { question: "Will there be visible scars?", answer: "No. Scars are hidden behind the ears." },
    { question: "Is otoplasty permanent?", answer: "Yes, results are long-lasting and stable." },
    { question: "Can otoplasty be done on children?", answer: "Yes, commonly after the age of 5 when ear growth is complete." },
    { question: "How long does the surgery take?", answer: "Typically 1-2 hours, depending on complexity." },
    { question: "When can I return to normal activities?", answer: "Most patients resume normal routines within 1-2 weeks." },
    { question: "Is otoplasty safe in Malaysia?", answer: "Yes, when performed by a certified surgeon in a licensed facility." }
  ]

  const otoplastyTypes = [
    { title: "Ear Pinning (Setback Otoplasty)", desc: "Repositions prominent ears closer to the head for a more balanced appearance." },
    { title: "Ear Reshaping", desc: "Corrects abnormal contours or poorly formed folds for improved ear shape." },
    { title: "Ear Reduction", desc: "Reduces oversized ears for better facial proportion and harmony." }
  ]

  const procedureSteps = [
    "A discreet incision behind the ear",
    "Reshaping or folding ear cartilage",
    "Securing the ear closer to the head with internal sutures",
    "Careful symmetry assessment before closure"
  ]

  const benefits = [
    "Permanently corrects prominent ears",
  ...
  const candidateCriteria = [
    "Are bothered by prominent or misshapen ears",
    "Have fully developed ear cartilage (usually after age 5)",
    "Are in good general health",
    "Have realistic expectations"
  ]

  const comparisonData = [
    { aspect: "Permanence", otoplasty: "Permanent", nonSurgical: "Temporary or ineffective" },
    { aspect: "Age suitability", otoplasty: "Children & adults", nonSurgical: "Limited (infants only)" },
    { aspect: "Scar visibility", otoplasty: "Hidden", nonSurgical: "None" },
    { aspect: "Correction level", otoplasty: "Structural", nonSurgical: "Minimal" }
  ]
  ...
  return (
    <>
      ...
      <main className="otoplasty-page bg-white text-zinc-900 w-full max-w-full">
        {/* Hero Section */}
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">Otoplasty in Malaysia.</span> <br />
                <span className="text-[#FE7623] text-[18px] md:text-[28px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">Ear Pinning Surgery for Natural, Balanced Facial Proportions</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify space-y-4" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>Ears play a quiet but powerful role in facial balance. When they protrude excessively, are asymmetrical, or shaped irregularly, they can draw disproportionate attention - often from a young age. Otoplasty, commonly known as ear pinning surgery, is a precise surgical procedure designed to reposition or reshape the ears so they sit closer to the head and align naturally with the rest of the face.</p>
                <p style={{fontSize: '14px'}}>In Malaysia, otoplasty is classified as a regulated surgical procedure and must be performed by a registered medical practitioner in a licensed medical facility under standards set by the Ministry of Health Malaysia. When performed by an experienced plastic surgeon, otoplasty delivers subtle, permanent correction without altering the patient&apos;s identity or expression.</p>
              </div>
            ...
            <div className="order-2 lg:order-2 relative rounded-2xl overflow-hidden aspect-[3/2] md:aspect-[4/3] group animate-fadeInRight opacity-0 img-zoom transition-all duration-500" style={{animationDelay: '0.3s', animationFillMode: 'forwards', boxShadow: '0 10px 40px -10px rgba(0,0,0,0.3), 0 0 20px rgba(0,0,0,0.1)'}}>
              <BaseImage
                ...
                alt="Otoplasty Ear Surgery Malaysia"
                fill
                ...
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-base font-semibold text-zinc-900">Ear Reshaping & Balance</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 px-4 md:px-8">
              <div data-animate="def-1" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">What Is Otoplasty?</h2>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    "Congenital ear shape irregularities"
                  ].map((item, i) => (
              ...
              <div data-animate="def-2" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6">How Otoplasty Surgery Is Performed</h3>
                ...
                <div className="p-4 bg-orange-50 rounded-xl border border-orange-100 mt-6">
                  <p className="text-sm text-zinc-700"><strong>Note:</strong> Institutions such as the Mayo Clinic and the American Society of Plastic Surgeons recognise otoplasty as a safe, well-established procedure for both adults and children with prominent or misshapen ears.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-8 md:py-16 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <div data-animate="reasons-header" className={`max-w-2xl mb-10 transition-all duration-700 ${isVisible('reasons-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">Common Reasons Patients Choose Ear Pinning Surgery</h2>
              <p className="text-zinc-500 text-sm">The motivation is rarely vanity - it is comfort, confidence, and facial balance.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {commonReasons.map((reason, i) => (
                <div key={i} data-animate={`reason-${i}`} className={`bg-white p-6 rounded-2xl border border-zinc-200 hover:border-[#FE7623] hover:shadow-xl transition-all duration-300 group ${isVisible(`reason-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#FE7623] to-orange-400 text-white flex items-center justify-center mb-4 text-lg font-bold">
                    {i + 1}
                  </div>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="types-header" className={`max-w-2xl mb-12 px-4 md:px-8 transition-all duration-700 ${isVisible('types-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">Types of Otoplasty Techniques</h2>
              <p className="text-zinc-500 text-sm">The surgical approach is individualised based on anatomy and goals.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 md:px-8">
              {otoplastyTypes.map((type, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-4 md:px-8">
            ...
            <div data-animate="benefits-content" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('benefits-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">Benefits of Otoplasty</h2>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-4 md:px-8">
              <div data-animate="candidate-content" className={`transition-all duration-700 ${isVisible('candidate-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">Who Is a Good Candidate for Otoplasty?</h2>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6">
              ...
              <div data-animate="recovery-content" className={`transition-all duration-700 ${isVisible('recovery-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="space-y-4">
                  {[
                    { time: "Week 1", desc: "Mild swelling, head dressing or bandage" },
                    { time: "Week 1-2", desc: "Return to work or school" },
                    { time: "Week 4-6", desc: "Ears settle into final position" },
                    { time: "3 Months", desc: "Full healing and scar maturation" }
                  ].map((item, i) => (
                ...
                <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 mt-6">
                  <p className="text-sm text-blue-700"><strong>Note:</strong> Postoperative care follows globally accepted surgical safety and wound-care principles aligned with guidance from the World Health Organization.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-8 md:py-24 px-4 md:px-8 lg:px-16 bg-zinc-50 overflow-hidden">
          <div className="w-full max-w-[1400px] mx-auto">
            <div data-animate="comparison-header" className={`text-center mb-12 transition-all duration-700 ${isVisible('comparison-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">Otoplasty vs Non-Surgical Ear Correction</h2>
              <p className="text-zinc-500 text-sm max-w-2xl mx-auto">Non-surgical methods have limited effectiveness beyond infancy.</p>
            </div>
              ...
              <table className="w-full text-sm bg-white rounded-2xl overflow-hidden shadow-lg">
                <thead>
                  <tr className="border-b border-zinc-200 bg-zinc-100">
                    <th className="text-left py-4 px-4 md:px-6 text-zinc-600 font-semibold">Aspect</th>
                    <th className="text-left py-4 px-4 md:px-6 text-[#FE7623] font-semibold">Otoplasty</th>
                    <th className="text-left py-4 px-4 md:px-6 text-zinc-600 font-semibold">Non-Surgical Methods</th>
                  </tr>
                </thead>
                <tbody>
                  {comparisonData.map((row, i) => (
                    <tr key={i} className="border-b border-zinc-100 bg-white hover:bg-zinc-50 transition-colors duration-300">
                      <td className="py-4 px-4 md:px-6 text-zinc-700 font-medium">{row.aspect}</td>
                      <td className="py-4 px-4 md:px-6 text-zinc-900">{row.otoplasty}</td>
                      <td className="py-4 px-4 md:px-6 text-zinc-500">{row.nonSurgical}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 px-4 md:px-8">
            ...
            <div className="lg:col-span-1">
              <div data-animate="pricing" className={`bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl lg:sticky lg:top-24 shadow-2xl transition-all duration-700 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] group card-shine ${isVisible('pricing') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-zinc-400 text-sm mb-6">Otoplasty surgery cost varies depending on:</p>
                <ul className="space-y-4 mb-8">
                  {["Complexity of ear correction", "One or both ears", "Anaesthesia type", "Facility fees", "Surgeon's expertise"].map((item, i) => (
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Get answers to common concerns about otoplasty</p>
                </div>
              </div>
              <div className="space-y-3">
                {faqs.map((faq, index) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 relative overflow-hidden w-full">
          ...
          <div data-animate="cta" className={`max-w-5xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-[#FE7623] mb-6 transition-colors duration-300 cursor-default px-4">Achieve Natural Facial Balance</h2>
            <p className="text-base sm:text-lg text-zinc-500 mb-10 max-w-3xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 px-6 md:px-10">
              <a href="https://wa.me/60142616007?text=Hi%2C%20I%27m%20interested%20in%20Otoplasty%20Surgery" className="btn-magnetic w-full sm:w-auto inline-flex justify-center items-center gap-3 bg-gradient-to-r from-[#FE7623] to-orange-500 text-white px-12 py-5 rounded-full text-base font-semibold hover:from-[#e56010] hover:to-orange-400 transition-all duration-300 shadow-xl shadow-orange-500/30 hover:shadow-2xl hover:shadow-orange-500/50 group animate-glow">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3 px-4">
              {["Otoplasty Malaysia", "ear pinning surgery", "ear reshaping", "prominent ear correction", "ear surgery"].map((tag, i) => (

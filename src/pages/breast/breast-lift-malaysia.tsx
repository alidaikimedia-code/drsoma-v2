      ...
      <main className="breast-lift-page bg-white text-header-black">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[600px] w-full rounded-2xl sm:rounded-3xl overflow-hidden animate-fadeInRight opacity-0 group" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
              ...
              <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8 bg-[#FE7623] px-4 py-3 sm:px-8 sm:py-5 rounded-lg sm:rounded-xl shadow-xl max-w-[200px] sm:max-w-xs animate-float">
                ...
                <p className="text-[10px] sm:text-xs text-white/90 mt-1 leading-snug">Dr. Soma focuses on natural shape, improved symmetry, and safe surgical outcomes.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="def-1" className={`transition-all duration-700 text-center sm:text-left ${isVisible('def-1') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h2 className="text-2xl sm:text-3xl font-semibold text-header-black mb-4 sm:mb-6">What Is a Breast Lift?</h2>
              ...
              <div data-animate="def-2" className={`transition-all duration-700 delay-200 text-center sm:text-left ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-xl sm:text-2xl font-semibold text-header-black mb-4 sm:mb-6">Why Breasts Sag (Ptosis)</h3>
                ...
                <h4 className="text-xs sm:text-sm font-bold text-header-black uppercase mb-2 sm:mb-3">Common Concerns Addressed:</h4>
                <ul className="space-y-2 text-xs sm:text-sm text-para-black text-left">
                  {["Breasts that sit lower on the chest", "Loss of firmness and projection", "Stretched or enlarged areolas", "Breast asymmetry due to sagging"].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 hover:text-[#FE7623] transition-colors cursor-pointer">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#FE7623] flex-shrink-0"></div> {item}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-white border-b border-zinc-100">
          <div data-animate="how-it-works" className={`max-w-4xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl sm:text-3xl font-semibold text-header-black mb-3 sm:mb-4">How a Breast Lift Works</h2>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              ...
              <div key={i} data-animate={`step-${i}`} className={`p-4 sm:p-6 bg-zinc-50 rounded-lg sm:rounded-xl hover:bg-[#FE7623] hover:text-white group transition-all duration-500 hover:-translate-y-2 hover:shadow-xl cursor-pointer ${isVisible(`step-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                ...
                <p className="text-[10px] sm:text-xs text-para-black leading-relaxed group-hover:text-white/80 transition-colors">{step.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Techniques Grid */}
        <section id="types" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="types-header" className={`mb-8 sm:mb-12 lg:mb-16 max-w-2xl text-center sm:text-left mx-auto sm:mx-0 transition-all duration-700 ${isVisible('types-header') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
              <h2 className="text-2xl sm:text-3xl font-semibold text-header-black mb-3 sm:mb-4">Types of Breast Lift Offered</h2>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="table-1" className={`transition-all duration-700 ${isVisible('table-1') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-lg sm:text-xl font-semibold text-header-black mb-4 sm:mb-6 flex items-center justify-center sm:justify-start gap-3">What a Breast Lift Improves</h3>
              ...
              <div data-animate="table-2" className={`transition-all duration-700 ${isVisible('table-2') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-lg sm:text-xl font-semibold text-header-black mb-4 sm:mb-6 flex items-center justify-center sm:justify-start gap-2 sm:gap-3 flex-wrap">
        ...
        {/* Scientific Evidence */}
        <section className="py-10 sm:py-12 lg:py-16 px-4 sm:px-6 bg-zinc-900 text-white">
          <div className="max-w-7xl mx-auto">
            <div data-animate="evidence" className={`text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('evidence') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
              <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-white">Scientific Evidence & Authority</h3>
              ...
              {[
                ...
                <a key={i} href={source.url} target="_blank" rel="noopener noreferrer" className="block p-3 sm:p-4 rounded-lg bg-zinc-800 border border-zinc-700 hover:border-[#FE7623] hover:bg-zinc-800/80 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
                  <div className="flex items-center justify-between">
                    ...
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-para-black group-hover:text-[#FE7623] group-hover:rotate-12 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                  </div>
                  <p className="text-[10px] sm:text-xs text-para-black mt-2 group-hover:text-white/70 transition-colors">{source.desc}</p>
                </a>
              ))}
            </div>
          </div>
        ...
        {/* Recovery & Timeline */}
        <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="recovery" id="recovery" className={`transition-all duration-700 text-center sm:text-left ${isVisible('recovery') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-lg sm:text-xl font-semibold text-header-black mb-6 sm:mb-8">Post-Operative Recovery</h3>
              ...
              <div data-animate="expect" className={`bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-zinc-100 shadow-sm h-fit hover:shadow-xl transition-all duration-500 ${isVisible('expect') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-lg sm:text-xl font-semibold text-header-black mb-4 sm:mb-6 text-center sm:text-left">What to Expect</h3>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              <div data-animate="candidates" className={`transition-all duration-700 text-center sm:text-left ${isVisible('candidates') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-2xl sm:text-3xl font-semibold text-header-black mb-4 sm:mb-6">Who Is a Good Candidate?</h3>
                <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 text-left">
                  {["Sagging breasts or downward-pointing nipples.", "Stable weight and good overall health.", "Finished breastfeeding and pregnancy plans (recommended).", "Non-smoker or willing to stop temporarily.", "Realistic expectations."].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 sm:gap-4 group cursor-pointer">
                      <div className="mt-1 min-w-[24px] text-[#FE7623] group-hover:scale-110 transition-transform"><svg className="w-6 h-6 sm:w-7 sm:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div>
              ...
              <div data-animate="benefits" className={`transition-all duration-700 text-center sm:text-left ${isVisible('benefits') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl sm:text-3xl font-semibold text-header-black mb-4 sm:mb-6">Benefits of a Breast Lift</h3>
                <div className="grid grid-cols-1 gap-3 sm:gap-4">
                  {[
                    ...
                    <div key={i} className="flex gap-3 sm:gap-4 items-center p-3 sm:p-4 rounded-lg bg-zinc-50 hover:bg-[#FE7623] group transition-all duration-300 cursor-pointer hover:-translate-y-1 hover:shadow-lg">
                      <div className="p-2 sm:p-2.5 bg-white rounded-md shadow-sm text-[#FE7623] group-hover:bg-white/20 group-hover:text-white transition-all"><svg className="w-6 h-6 sm:w-7 sm:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={item.icon} /></svg></div>
        ...
        {/* USP Section */}
        <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-zinc-900 text-white">
          <div data-animate="usp" className={`max-w-7xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('usp') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6">What Makes Dr. Soma&apos;s Breast Lift Different?</h2>
          </div>
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              ...
              <div key={i} className="bg-zinc-800 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-zinc-700 hover:border-[#FE7623] hover:-translate-y-2 hover:shadow-xl hover:shadow-[#FE7623]/10 transition-all duration-500 group cursor-pointer">
                <svg className="w-10 h-10 sm:w-12 sm:h-12 text-[#FE7623] mb-3 sm:mb-4 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={item.icon} /></svg>
                ...
                <p className="text-[10px] sm:text-xs text-para-black group-hover:text-white/70 transition-colors">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-white border-b border-zinc-100">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="testimonials" className={`text-xl sm:text-2xl font-semibold text-header-black mb-8 sm:mb-12 text-center transition-all duration-700 ${isVisible('testimonials') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>Patient Experiences</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {[
                ...
                <div key={i} data-animate={`review-${i}`} className={`bg-zinc-50 p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-zinc-100 hover:border-[#FE7623] hover:-translate-y-2 hover:shadow-xl transition-all duration-500 cursor-pointer group ${isVisible(`review-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  <div className="flex gap-1 text-[#FE7623] mb-4 sm:mb-6">
        ...
        <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-zinc-50">
          <div data-animate="pricing" className={`max-w-4xl mx-auto text-center transition-all duration-700 ${isVisible('pricing') ? 'opacity-100 scale-100' : 'opacity-100 sm:opacity-0 sm:scale-95'}`}>
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6">Pricing Guide</h2>
        ...
        {/* FAQ Section */}
        <section className="py-12 sm:py-16 lg:py-24 bg-[#FAFAF9]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div data-animate="faq-header" className={`text-center mb-8 sm:mb-12 lg:mb-16 transition-all duration-700 ${isVisible('faq-header') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-header-black mb-3 sm:mb-5">
        ...
        {/* Final CTA */}
        <section id="contact" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-zinc-50">
          <div data-animate="cta" className={`max-w-4xl mx-auto text-center transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-header-black mb-4 sm:mb-6">Restore a Youthful, Lifted Shape</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4">
              <a href="https://wa.me/60142616007" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-[#FE7623] text-white px-6 py-3 sm:px-8 sm:py-3.5 rounded-full text-sm font-semibold hover:bg-[#e56010] hover:scale-105 hover-glow transition-all duration-300 shadow-lg shadow-orange-200">
                <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24">
                  <path fill="#25D366" d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
                Chat on WhatsApp
              </a>
              <Link href="/contact-us" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-white text-header-black border border-zinc-200 px-6 py-3 sm:px-8 sm:py-3.5 rounded-full text-sm font-medium hover:bg-zinc-50 hover:border-[#FE7623] hover:text-[#FE7623] hover:scale-105 transition-all duration-300 group">

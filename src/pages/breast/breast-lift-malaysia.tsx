...
export default function BreastLiftMalaysia() {
  ...
  const faqs = [
    { question: t('bl.faq0Q'), answer: t('bl.faq0A') },
    { question: t('bl.faq1Q'), answer: t('bl.faq1A') },
    { question: t('bl.faq2Q'), answer: t('bl.faq2A') },
    { question: t('bl.faq3Q'), answer: t('bl.faq3A') },
    { question: t('bl.faq4Q'), answer: t('bl.faq4A') },
    { question: t('bl.faq5Q'), answer: t('bl.faq5A') },
    { question: t('bl.faq6Q'), answer: t('bl.faq6A') },
    { question: t('bl.faq7Q'), answer: t('bl.faq7A') },
    { question: t('bl.faq8Q'), answer: t('bl.faq8A') },
    { question: t('bl.faq9Q'), answer: t('bl.faq9A') }
  ]
      ...
      <main className="breast-lift-page bg-white text-header-black">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">{t('bl.heroTitle')}</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">{t('bl.heroSubtitle')}</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}} className="mb-4">{t('bl.heroDesc1')}</p>
                <p style={{fontSize: '14px'}}>{t('bl.heroDesc2')}</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fadeInUp opacity-0 relative z-10" style={{animationDelay: '0.4s', animationFillMode: 'forwards'}}>
              ...
              <div className="flex items-center gap-4 mt-8 animate-fadeInUp opacity-0" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
                ...
                <span className="text-sm text-zinc-600 font-medium">{t('bl.trustedBy')} <span className="text-[#FE7623] font-bold">500+</span> {t('bl.happyPatients')}</span>
              </div>
            </div>
              ...
              <div className="hidden md:block absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-[10px] md:text-xs font-bold uppercase tracking-wide text-zinc-400">{t('bl.goalLabel')}</p>
                      <p className="text-sm md:text-base font-semibold text-zinc-900">{t('bl.goalValue')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="def-1" className={`transition-all duration-700 text-center sm:text-left ${isVisible('def-1') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.whatIsTitle')}</h2>
                <p className="text-sm sm:text-base text-para-black leading-relaxed mb-4 sm:mb-6">
                  {t('bl.whatIsDesc1').split(/<mastopexy>|<\/mastopexy>|<mayo>|<\/mayo>/).map((part: string, i: number) => {
                    if (i === 1) return <span key={i} className="text-[#FE7623] font-semibold">{part}</span>
                    if (i === 3) return <span key={i} className="font-semibold text-header-black">{part}</span>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-lg border border-zinc-100 hover:border-[#FE7623]/50 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group text-left">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-header-black">{t('bl.nippleElevTitle')}</h4>
                      <p className="text-xs text-para-black mt-1">{t('bl.nippleElevDesc')}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-lg border border-zinc-100 hover:border-[#FE7623]/50 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group text-left">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-header-black">{t('bl.skinReductionTitle')}</h4>
                      <p className="text-xs text-para-black mt-1">{t('bl.skinReductionDesc')}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div data-animate="def-2" className={`transition-all duration-700 delay-200 text-center sm:text-left ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.ptosisTitle')}</h3>
                <p className="text-xs sm:text-sm text-para-black mb-4 sm:mb-6">{t('bl.ptosisDesc')}</p>
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  {[
                    { icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z", title: t('bl.cause0Title'), desc: t('bl.cause0Desc') },
                    { icon: "M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3", title: t('bl.cause1Title'), desc: t('bl.cause1Desc') },
                    { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", title: t('bl.cause2Title'), desc: t('bl.cause2Desc') },
                    { icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z", title: t('bl.cause3Title'), desc: t('bl.cause3Desc') }
                  ].map((item, i) => (
        ...
        <section className="py-8 md:py-24 px-4 sm:px-6 bg-white border-b border-zinc-100">
          <div data-animate="how-it-works" className={`max-w-4xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-3 sm:mb-4">{t('bl.howTitle')}</h2>
            <p className="text-para-black text-xs sm:text-sm max-w-2xl mx-auto">{t('bl.howDesc')}</p>
          </div>
          <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              { num: t('bl.step0Num'), title: t('bl.step0Title'), desc: t('bl.step0Desc') },
              { num: t('bl.step1Num'), title: t('bl.step1Title'), desc: t('bl.step1Desc') },
              { num: t('bl.step2Num'), title: t('bl.step2Title'), desc: t('bl.step2Desc') },
              { num: t('bl.step3Num'), title: t('bl.step3Title'), desc: t('bl.step3Desc') }
            ].map((step, i) => (
        ...
        <section id="types" className="py-8 md:py-24 px-4 sm:px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="types-header" className={`mb-8 sm:mb-12 lg:mb-16 max-w-2xl text-center sm:text-left mx-auto sm:mx-0 transition-all duration-700 ${isVisible('types-header') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
              <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-3 sm:mb-4">{t('bl.typesTitle')}</h2>
              <p className="text-para-black text-xs sm:text-sm">{t('bl.typesDesc')}</p>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              {[
                { num: "1", title: t('bl.type0Title'), sub: t('bl.type0Sub'), desc: t('bl.type0Desc'), dark: false },
                { num: "2", title: t('bl.type1Title'), sub: t('bl.type1Sub'), desc: t('bl.type1Desc'), dark: false },
                { num: "3", title: t('bl.type2Title'), sub: t('bl.type2Sub'), desc: t('bl.type2Desc'), dark: false },
                { num: "4", title: t('bl.type3Title'), sub: t('bl.type3Sub'), desc: t('bl.type3Desc'), dark: true }
              ].map((type, i) => (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="table-1" className={`transition-all duration-700 ${isVisible('table-1') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6 flex items-center justify-center sm:justify-start gap-3">{t('bl.improvesTitle')}</h3>
                <div className="border border-zinc-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 overflow-x-auto">
                  <table className="w-full text-xs sm:text-sm text-left min-w-[300px]">
                    <thead className="bg-zinc-50 text-header-black font-semibold border-b border-zinc-200">
                      <tr><th className="p-3 sm:p-4">{t('bl.improvesArea')}</th><th className="p-3 sm:p-4">{t('bl.improvesImp')}</th></tr>
                    </thead>
                    <tbody className="divide-y divide-zinc-100">
                      {[
                        { area: t('bl.imp0Area'), imp: t('bl.imp0Imp') },
                        { area: t('bl.imp1Area'), imp: t('bl.imp1Imp') },
                        { area: t('bl.imp2Area'), imp: t('bl.imp2Imp') },
                        { area: t('bl.imp3Area'), imp: t('bl.imp3Imp') },
                        { area: t('bl.imp4Area'), imp: t('bl.imp4Imp') }
                      ].map((row, i) => (
              ...
              <div data-animate="table-2" className={`transition-all duration-700 ${isVisible('table-2') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6 flex items-center justify-center sm:justify-start gap-2 sm:gap-3 flex-wrap">
                  {t('bl.compTitle')}
                  <span className="text-[10px] uppercase bg-orange-100 text-[#FE7623] px-2 py-1 rounded font-bold animate-pulse">{t('bl.compGuide')}</span>
                </h3>
                <div className="border border-zinc-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 overflow-x-auto">
                  <table className="w-full text-xs sm:text-sm text-left min-w-[300px]">
                    <thead className="bg-zinc-50 text-header-black font-semibold border-b border-zinc-200">
                      <tr><th className="p-3 sm:p-4">{t('bl.compFeature')}</th><th className="p-3 sm:p-4">{t('bl.compLift')}</th><th className="p-3 sm:p-4">{t('bl.compAug')}</th></tr>
                    </thead>
                    <tbody className="divide-y divide-zinc-100">
                      {[
                        { feat: t('bl.comp0Feat'), lift: t('bl.comp0Lift'), aug: t('bl.comp0Aug'), liftHighlight: true },
                        { feat: t('bl.comp1Feat'), lift: t('bl.comp1Lift'), aug: t('bl.comp1Aug'), liftHighlight: true },
                        { feat: t('bl.comp2Feat'), lift: t('bl.comp2Lift'), aug: t('bl.comp2Aug'), liftHighlight: false },
                        { feat: t('bl.comp3Feat'), lift: t('bl.comp3Lift'), aug: t('bl.comp3Aug'), liftHighlight: true }
                      ].map((row, i) => (
                        <tr key={i} className="hover:bg-zinc-50 transition-colors">
        ...
        <section className="py-12 md:py-24 px-4 sm:px-6 bg-zinc-900 text-white">
          <div className="max-w-7xl mx-auto">
            <div data-animate="evidence" className={`text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('evidence') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
              <h3 className="text-2xl font-semibold tracking-tight mb-3 sm:mb-4 text-[#FE7623]">{t('bl.evidenceTitle')}</h3>
              <p className="text-para-black text-xs sm:text-sm leading-relaxed max-w-2xl mx-auto">{t('bl.evidenceDesc')}</p>
              <div className="flex flex-wrap justify-center gap-2 text-[10px] sm:text-xs font-mono text-para-black mt-3 sm:mt-4">
                <span className="hover:text-[#FE7623] transition-colors cursor-pointer">{t('bl.tag0')}</span>
                <span className="hover:text-[#FE7623] transition-colors cursor-pointer">{t('bl.tag1')}</span>
                <span className="hover:text-[#FE7623] transition-colors cursor-pointer">{t('bl.tag2')}</span>
                <span className="hover:text-[#FE7623] transition-colors cursor-pointer">{t('bl.tag3')}</span>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              {[
                { name: t('bl.auth0Name'), url: "https://www.mayoclinic.org/", desc: t('bl.auth0Desc') },
                { name: t('bl.auth1Name'), url: "https://www.health.harvard.edu/", desc: t('bl.auth1Desc') },
                { name: t('bl.auth2Name'), url: "https://pubmed.ncbi.nlm.nih.gov/", desc: t('bl.auth2Desc') }
              ].map((source, i) => (
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              <div data-animate="recovery" id="recovery" className={`transition-all duration-700 text-center sm:text-left ${isVisible('recovery') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-6 sm:mb-8">{t('bl.recoveryTitle')}</h3>
                <div className="relative pl-6 sm:pl-8 border-l-2 border-zinc-200 space-y-6 sm:space-y-10 text-left">
                  {[
                    { title: t('bl.rec0Title'), desc: t('bl.rec0Desc'), active: true },
                    { title: t('bl.rec1Title'), desc: t('bl.rec1Desc'), active: false },
                    { title: t('bl.rec2Title'), desc: t('bl.rec2Desc'), active: false },
                    { title: t('bl.rec3Title'), desc: t('bl.rec3Desc'), active: false }
                  ].map((step, i) => (
              ...
              <div data-animate="expect" className={`bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-zinc-100 shadow-sm h-fit hover:shadow-xl transition-all duration-500 ${isVisible('expect') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6 text-center sm:text-left">{t('bl.expectTitle')}</h3>
                <div className="mb-6 sm:mb-8">
                  <h4 className="text-xs sm:text-sm font-bold text-header-black mb-3 sm:mb-4 text-center sm:text-left">{t('bl.expectReceive')}</h4>
                  <ul className="space-y-2 sm:space-y-3">
                    {[t('bl.expect0'), t('bl.expect1'), t('bl.expect2'), t('bl.expect3')].map((item, i) => (
                ...
                <div className="p-4 sm:p-5 bg-orange-50 rounded-lg border border-orange-100 hover:border-[#FE7623] transition-colors">
                  <h4 className="text-xs sm:text-sm font-bold text-orange-900 mb-2">{t('bl.painTitle')}</h4>
                  <p className="text-xs sm:text-sm text-orange-800 leading-relaxed italic">{t('bl.painDesc')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              <div data-animate="candidates" className={`transition-all duration-700 text-center sm:text-left ${isVisible('candidates') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.candidateTitle')}</h3>
                <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 text-left">
                  {[t('bl.cand0'), t('bl.cand1'), t('bl.cand2'), t('bl.cand3')].map((item, i) => (
                ...
                <div className="p-4 sm:p-5 bg-red-50 rounded-lg border border-red-100 flex items-start gap-3 hover:border-red-300 transition-colors text-left">
                  ...
                  <div className="text-xs sm:text-sm text-red-900/80 leading-relaxed"><span className="font-bold">{t('bl.notSuitable')}</span> {t('bl.notSuitableDesc')}</div>
                </div>
              </div>
              <div data-animate="benefits" className={`transition-all duration-700 text-center sm:text-left ${isVisible('benefits') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.benefitsTitle')}</h3>
                <div className="grid grid-cols-1 gap-3 sm:gap-4">
                  {[
                    { icon: "M5 10l7-7m0 0l7 7m-7-7v18", text: t('bl.ben0') },
                    { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", text: t('bl.ben1') },
                    { icon: "M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z", text: t('bl.ben2') },
                    { icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01", text: t('bl.ben3') },
                    { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", text: t('bl.ben4') }
                  ].map((item, i) => (
        ...
        <section className="py-8 md:py-24 px-4 sm:px-6 bg-zinc-900 text-white">
          <div data-animate="usp" className={`max-w-7xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('usp') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.uspTitle')}</h2>
          </div>
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              { icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z", title: t('bl.usp0Title'), desc: t('bl.usp0Desc') },
              { icon: "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z", title: t('bl.usp1Title'), desc: t('bl.usp1Desc') },
              { icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4", title: t('bl.usp2Title'), desc: t('bl.usp2Desc') },
              { icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z", title: t('bl.usp3Title'), desc: t('bl.usp3Desc') }
            ].map((item, i) => (
        ...
        <section className="py-8 md:py-24 px-4 sm:px-6 bg-white border-b border-zinc-100">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="testimonials" className={`text-2xl font-semibold tracking-tight text-[#FE7623] mb-8 sm:mb-12 text-center transition-all duration-700 ${isVisible('testimonials') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>{t('bl.testimonialsTitle')}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {[
                { name: t('bl.test0Name').split(', ')[0], age: t('bl.test0Name').split(', ')[1], text: t('bl.test0Text') },
                { name: t('bl.test1Name').split(', ')[0], age: t('bl.test1Name').split(', ')[1], text: t('bl.test1Text') },
                { name: t('bl.test2Name').split(', ')[0], age: t('bl.test2Name').split(', ')[1], text: t('bl.test2Text') }
              ].map((review, i) => (
                <div key={i} data-animate={`review-${i}`} className={`bg-zinc-50 p-5 sm:p-6 lg:p-8 rounded-xl sm:rounded-2xl border border-zinc-100 hover:border-[#FE7623] hover:-translate-y-2 hover:shadow-xl transition-all duration-500 cursor-pointer group text-center sm:text-left ${isVisible(`review-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[10px] sm:text-xs text-para-black">{t('bl.test0Role')}</p>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <section id="contact" className="pt-0 pb-8 md:pt-0 md:pb-24 px-4 sm:px-6 bg-zinc-50">
          <div data-animate="cta" className={`max-w-4xl mx-auto text-center transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">{t('bl.ctaTitle')}</h2>
            <p className="text-sm sm:text-base lg:text-lg text-para-black mb-6 sm:mb-8 lg:mb-10 max-w-xl mx-auto px-2">{t('bl.ctaDesc')}</p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 relative z-10">
              ...
              <Link href="/contact" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-white text-header-black border border-zinc-200 px-8 py-3 sm:py-3.5 rounded-full text-sm font-medium hover:bg-zinc-50 hover:border-[#FE7623] hover:text-[#FE7623] hover:scale-105 transition-all duration-300 group">
                ...
                {t('bl.bookConsultationCta')}
              </Link>
            </div>
            <p className="mt-6 sm:mt-8 text-[10px] sm:text-xs text-para-black">{t('bl.ctaTag')}</p>
          </div>
        </section>
      </main>
    </>

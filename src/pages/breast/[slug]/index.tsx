...
export async function getStaticPaths() {
  ...
  const excludedSlugs = ['breast-augmentation-malaysia', 'breast-lift-malaysia', 'breast-reduction-malaysia', 'fat-transfer-breast-augmentation-malaysia', 'breast-implant-removal-malaysia', 'breast-revision-surgery-malaysia'];

  ...
  return (
    <>
      ...
      <main className="breast-reduction-page bg-white text-header-black">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">Breast Reduction in Malaysia</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">Lighter. Proportionate. More Comfortable.</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}} className="mb-4">Large, heavy breasts can cause more than aesthetic concerns. Many patients experience chronic neck, shoulder, and back pain, posture strain, bra-strap grooving, skin irritation under the breast fold, and difficulty exercising or finding comfortable clothing. Clinical guidance from the UK NHS recognises breast reduction surgery as a treatment option when large breasts contribute to ongoing physical discomfort and daily functional limitation.</p>
                <p style={{fontSize: '14px'}}>At Dr. Soma Plastic Surgery, every breast reduction procedure is performed by Dr. Soma, a board-certified plastic surgeon with extensive experience in aesthetic and functional breast surgery. The goal is not simply to &quot;make breasts smaller&quot; but to achieve a balanced size, improved symmetry, healthier nipple position, and long-term comfort using careful planning and safety-focused technique.</p>
              </div>
            ...
            {/* Hero Image */}
            <div className="order-1 lg:order-2 relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] md:aspect-[4/3] group animate-fadeInRight opacity-0 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] transition-shadow duration-500" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                ...
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-base font-semibold text-zinc-900">Balanced Proportion & Comfort</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Definition & Reasons */}
        <section id="procedure" className="py-8 md:py-24 px-4 sm:px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              ...
              <div data-animate="definition" className={`transition-all duration-700 text-center sm:text-left ${isVisible('definition') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:-translate-x-10'}`}>
                <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">What Is Breast Reduction?</h2>
              ...
              <div data-animate="reasons" className={`transition-all duration-700 delay-200 text-center sm:text-left ${isVisible('reasons') ? 'opacity-100 translate-x-0' : 'opacity-100 sm:opacity-0 sm:translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">Why Patients Choose Reduction</h3>
        ...
        <section className="py-8 md:py-24 px-4 sm:px-6 bg-white border-b border-zinc-100">
          <div data-animate="how-it-works" className={`max-w-4xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('how-it-works') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-3 sm:mb-4">How Breast Reduction Works</h2>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              ...
              <div key={i} data-animate={`step-${i}`} className={`p-6 bg-zinc-50 rounded-xl hover:bg-[#FE7623] hover:shadow-xl transition-all duration-500 group cursor-pointer ${isVisible(`step-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: `${i * 100}ms` }}>
                ...
                <p className="text-xs text-para-black leading-relaxed group-hover:text-white transition-colors">{step.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="types" className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 sm:mb-12 lg:mb-16 max-w-2xl text-center sm:text-left mx-auto sm:mx-0">
              <h2 data-animate="types-title" className={`text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 transition-all duration-700 ${isVisible('types-title') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>Types of Breast Reduction</h2>
            ...
            <div className="md:hidden space-y-4">
              {[
                ...
                <div key={i} className="bg-zinc-50 rounded-lg p-4 border border-zinc-200">
                  <h4 className="font-semibold text-header-black mb-3 text-sm">{row.feature}</h4>
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between items-start">
                      <span className="text-para-black">Breast Reduction:</span>
                      <span className={`text-right ${row.reductionHighlight ? 'font-semibold text-[#FE7623]' : 'text-para-black'}`}>{row.reduction}</span>
                    </div>
                    <div className="flex justify-between items-start">
                      <span className="text-para-black">Breast Lift:</span>
                      <span className="text-right text-para-black">{row.lift}</span>
                    </div>
                    <div className="flex justify-between items-start">
                      <span className="text-para-black">Breast Augmentation:</span>
                      <span className={`text-right ${row.augHighlight ? 'font-semibold text-[#FE7623]' : 'text-para-black'}`}>{row.aug}</span>
                    </div>
                  </div>
                </div>
              ))}
                ...
                <div className="relative pl-8 border-l-2 border-zinc-200 space-y-10">
                  {[
                    ...
                    <div key={i} className="relative group cursor-pointer">
                      <div className={`absolute -left-[45px] top-0 w-7 h-7 rounded-full border-4 transition-all duration-300 group-hover:scale-125 ${step.active ? 'bg-[#FE7623] border-white shadow-sm' : 'bg-white border-zinc-200 group-hover:bg-[#FE7623] group-hover:border-white'}`}></div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              ...
              <div data-animate="benefits" className={`transition-all duration-700 text-center sm:text-left ${isVisible('benefits') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">Benefits of Breast Reduction</h3>
        ...
        <section className="py-8 md:py-24 px-4 sm:px-6 bg-zinc-900 text-white">
          <div data-animate="usp" className={`max-w-7xl mx-auto text-center mb-8 sm:mb-12 transition-all duration-700 ${isVisible('usp') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">What Makes Dr. Soma&apos;s Breast Reduction Different?</h2>
          </div>
        ...
        {/* FAQ Section */}
        <section className="pt-4 pb-8 md:pt-12 md:pb-24 bg-[#FAFAF9]">
        ...
        {/* Final CTA */}
        <section id="contact" className="pt-4 pb-8 md:pt-12 md:pb-24 px-4 sm:px-6 bg-zinc-50">
          <div data-animate="cta" className={`max-w-4xl mx-auto text-center transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-100 sm:opacity-0 sm:translate-y-10'}`}>
            <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-4 sm:mb-6">Relieve Heaviness & Restore Comfort</h2>
            <p className="text-sm sm:text-base lg:text-lg text-para-black mb-6 sm:mb-8 lg:mb-10 max-w-xl mx-auto px-2">Dr. Soma combines medical precision, aesthetic planning, and safety-first technique to deliver lighter, balanced, and long-lasting contour improvement.</p>
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4">
              ...
              <Link href="/contact-us" className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-white text-header-black border border-zinc-200 px-8 py-3 sm:py-3.5 rounded-full text-sm font-medium hover:bg-zinc-50 hover:border-[#FE7623] hover:text-[#FE7623] hover:scale-105 transition-all duration-300 group">
                ...
                <svg className="w-6 h-6 flex-shrink-0 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
              </Link>
            </div>

...
export default function PenileEnhancementMalaysia() {
  ...
  const faqs = [
    { question: "What is penile enhancement?", answer: "It refers to medical procedures that improve penile length, girth, or appearance." },
    { question: "Is penile enhancement safe?", answer: "Yes, when performed by qualified doctors in regulated medical facilities." },
    { question: "Are results permanent?", answer: "Surgical results are long-lasting; filler-based treatments may require maintenance." },
    { question: "Will penile enhancement affect function?", answer: "When done correctly, normal function and sensation are preserved." },
    { question: "Is the procedure painful?", answer: "Discomfort is usually mild to moderate and managed with medication." },
    { question: "How much size increase is realistic?", answer: "Improvements are modest and proportional, not dramatic." },
    { question: "How long is recovery?", answer: "Non-surgical recovery is 2–3 days; surgical recovery is 7–10 days with sexual activity avoided for 4–6 weeks." }
  ]

  const enhancementOptions = [
    { title: "Non-Surgical Girth Enhancement", points: ["Medical-grade fillers or fat transfer", "Focused on circumference improvement", "Performed under local anesthesia"] },
    { title: "Surgical Length Enhancement", points: ["Ligament release procedure", "Improves visible flaccid length", "Requires post-operative stretching protocols"] },
    { title: "Fat Grafting (Autologous Fat Transfer)", points: ["Uses patient's own fat", "Natural-feel enhancement", "Volume retention varies between individuals"] }
  ]

  const reasonsForEnhancement = [
    "Congenital anatomical concerns",
    "Post-trauma or post-surgical changes",
    "Body image or confidence issues",
    "Desire for proportional enhancement"
  ]

  const candidateCriteria = [
    "Are medically fit",
    "Have realistic expectations",
    "Seek proportional enhancement, not extremes",
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .penile-enhancement-page ::selection {
      ...
      <main className="penile-enhancement-page bg-white text-zinc-900 w-full max-w-full">
        {/* Hero Section */}
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">Penile Enhancement in Malaysia.</span> <br />
                <span className="text-[#FE7623] text-[18px] md:text-[28px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">Medically Guided Options for Size, Proportion & Confidence</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>Penile enhancement refers to medical procedures designed to improve penile length, girth, or overall proportion while preserving function and safety. In Malaysia, these procedures must be performed in licensed medical facilities under regulated surgical and clinical standards.</p>
                <p style={{fontSize: '14px', marginTop: '12px'}}>All medical aesthetic and surgical procedures are overseen by the Ministry of Health Malaysia, ensuring patient safety, ethical practice, and proper consent.</p>
              </div>
            ...
            <div className="order-2 lg:order-2 relative rounded-2xl overflow-hidden aspect-[3/2] md:aspect-[4/3] group animate-fadeInRight opacity-0 img-zoom transition-all duration-500" style={{animationDelay: '0.3s', animationFillMode: 'forwards', boxShadow: '0 10px 40px -10px rgba(0,0,0,0.3), 0 0 20px rgba(0,0,0,0.1)'}}>
              <BaseImage
                ...
                alt="Penile Enhancement Malaysia"
                fill
                ...
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-base font-semibold text-zinc-900">Proportional Enhancement</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* What Is Penile Enhancement Section */}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 px-4 md:px-8">
              <div data-animate="def-1" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">What Is Penile Enhancement?</h2>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6 text-justify">
                  Penile enhancement includes surgical and non-surgical medical techniques intended to improve penile dimensions or appearance. These procedures focus on proportion and anatomy rather than exaggerated size changes.
                </p>
                <div className="p-4 bg-orange-50 rounded-xl border border-orange-100">
                  <p className="text-sm text-zinc-700">The <strong>Mayo Clinic</strong> emphasizes that penile size concerns are common and that expectations should be realistic, with safety and function always taking priority.</p>
                </div>
              </div>

              {/* Common Reasons Men Seek Enhancement */}
              <div data-animate="def-2" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6">Common Reasons Men Seek Penile Enhancement</h3>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6">
                  Men may consider penile enhancement due to:
                </p>
                <div className="space-y-3">
                  {reasonsForEnhancement.map((item, i) => (
        ...
        {/* Penile Enhancement Options Section */}
        <section className="py-8 md:py-24 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="options-header" className={`max-w-2xl mb-12 px-4 md:px-8 transition-all duration-700 ${isVisible('options-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">Penile Enhancement Options in Malaysia</h2>
              <p className="text-zinc-500 text-sm">Various medical techniques are available depending on individual goals:</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 md:px-8">
              {enhancementOptions.map((item, i) => (
                <div key={i} data-animate={`option-${i}`} className={`relative bg-white pt-14 pb-8 px-6 rounded-2xl border border-zinc-200 card-3d overflow-visible hover:border-[#FE7623] group ${isVisible(`option-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  ...
                  <h3 className="text-lg font-bold text-zinc-900 mb-4 group-hover:text-[#FE7623] transition-colors">{item.title}</h3>
                  <ul className="space-y-2">
                    {item.points.map((point, j) => (
                      <li key={j} className="flex items-start gap-2 text-sm text-zinc-500">
                        <svg className="w-4 h-4 min-w-[16px] text-[#FE7623] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-4 md:px-8">
            ...
            <div data-animate="safety-content" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('safety-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">Safety and Medical Considerations</h2>
              <p className="text-zinc-500 text-sm leading-relaxed mb-6">
                Penile enhancement procedures require strict patient selection, sterile technique, and anatomical expertise.
              </p>
              <p className="text-zinc-500 text-sm leading-relaxed mb-6">
                Global principles of patient safety and informed consent align with standards published by the <strong>World Health Organization (WHO)</strong> for surgical and procedural care.
              </p>
              <div className="p-4 bg-green-50 rounded-xl border border-green-100">
                <p className="text-sm text-green-800"><strong>Important:</strong> All patients undergo medical evaluation to ensure suitability and to minimize risks.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="recovery-header" className={`max-w-2xl mb-12 px-4 md:px-8 transition-all duration-700 ${isVisible('recovery-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-zinc-500 text-sm">Recovery timelines vary depending on the technique used and follow guidance similar to postoperative recommendations outlined by major health systems such as the NHS.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-8">
              {[
                { time: "Non-Surgical", desc: "Resume routine activity in 2–3 days" },
                { time: "Surgical", desc: "7–10 days rest recommended" },
                { time: "Sexual Activity", desc: "Typically avoided for 4–6 weeks" },
                { time: "Final Results", desc: "Seen over several months as tissues settle" }
              ].map((item, i) => (
              ...
              <div data-animate="additional-content" className={`transition-all duration-700 ${isVisible('additional-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl shadow-2xl">
                  ...
                  <p className="text-zinc-300 text-sm mb-4">
                    Psychological reassurance and proper counseling are essential before pursuing any penile procedure.
                  </p>
                  <p className="text-zinc-400 text-sm">
                    A consultation determines the safest and most appropriate option based on your individual anatomy and goals.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 px-4 md:px-8">
            ...
            <div className="lg:col-span-1">
              <div data-animate="pricing" className={`bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl lg:sticky lg:top-24 shadow-2xl transition-all duration-700 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] group card-shine ${isVisible('pricing') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-zinc-400 text-sm mb-6">Penile enhancement cost varies depending on:</p>
                <ul className="space-y-4 mb-8">
                  {["Type of procedure selected", "Surgical vs non-surgical approach", "Materials and techniques used", "Anaesthesia and facility fees", "Surgeon's expertise and experience"].map((item, i) => (
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Get answers to common concerns about penile enhancement</p>
                </div>
              </div>
              <div className="space-y-3">
                {faqs.map((faq, index) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white relative overflow-hidden w-full">
          ...
          <div data-animate="cta" className={`max-w-5xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-[#FE7623] mb-6 transition-colors duration-300 cursor-default px-4">Confidential Consultation for Penile Enhancement</h2>
            <p className="text-base sm:text-lg text-zinc-500 mb-6 max-w-3xl mx-auto px-4">
              Take the first step towards proportional enhancement with medically guided procedures.
            </p>
            <p className="text-sm text-zinc-600 mb-10 pb-[7px] max-w-3xl mx-auto px-4">
              Schedule your private consultation with our specialist team today.
            </p>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3 px-4">
              {["Penile enhancement Malaysia", "male enhancement surgery", "girth enhancement", "length enhancement", "men's health"].map((tag, i) => (

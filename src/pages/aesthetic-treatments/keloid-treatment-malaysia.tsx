...
export default function KeloidTreatmentMalaysia() {
  ...
  const faqs = [
    { question: t('kel.faq1Q'), answer: t('kel.faq1A') },
    { question: t('kel.faq2Q'), answer: t('kel.faq2A') },
    { question: t('kel.faq3Q'), answer: t('kel.faq3A') },
    { question: t('kel.faq4Q'), answer: t('kel.faq4A') },
    { question: t('kel.faq5Q'), answer: t('kel.faq5A') },
    { question: t('kel.faq6Q'), answer: t('kel.faq6A') },
    { question: t('kel.faq7Q'), answer: t('kel.faq7A') },
    { question: t('kel.faq8Q'), answer: t('kel.faq8A') }
  ]
  ...
  const treatmentOptions = [
    {
      title: t('kel.opt1Title'),
      features: [t('kel.opt1Feat1'), t('kel.opt1Feat2'), t('kel.opt1Feat3')],
      highlight: true
    },
    {
      title: t('kel.opt2Title'),
      features: [t('kel.opt2Feat1'), t('kel.opt2Feat2'), t('kel.opt2Feat3')],
      highlight: false
    },
    {
      title: t('kel.opt3Title'),
      features: [t('kel.opt3Feat1'), t('kel.opt3Feat2'), t('kel.opt3Feat3')],
      highlight: false
    },
    {
      title: t('kel.opt4Title'),
      features: [t('kel.opt4Feat1'), t('kel.opt4Feat2'), t('kel.opt4Feat3')],
      highlight: false
    }
  ]
      ...
      <main className="keloid-page bg-white text-zinc-900">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">{t('kel.heroTitle')}</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">{t('kel.heroSubtitle')}</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify space-y-3" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>{t('kel.heroDesc1')}</p>
                <p style={{fontSize: '14px'}}>{t('kel.heroDesc2')}</p>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8 animate-fadeInUp opacity-0" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
                ...
                <span className="text-sm text-zinc-600 font-medium">{t('kel.trustedBy')} <span className="text-[#FE7623] font-bold">500+</span> {t('kel.patients')}</span>
              </div>
            </div>
              ...
              <div className="hidden md:block absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-[10px] md:text-xs font-bold uppercase tracking-wide text-zinc-400">{t('kel.treatmentLabel')}</p>
                      <p className="text-sm md:text-base font-semibold text-zinc-900">{t('kel.scarManagement')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              <div data-animate="def-1" className={`md:col-span-5 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">{t('kel.whatTitle')}</h2>
              ...
              <div data-animate="def-2" className={`md:col-span-7 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6">{t('kel.characteristicsTitle')}</h3>
        ...
        <section className="py-8 md:py-16 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="areas-header" className={`max-w-3xl mx-auto text-center mb-12 transition-all duration-700 ${isVisible('areas-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('kel.areasTitle')}</h2>
        ...
        <section className="py-8 md:py-16 px-6 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-animate="why-content" className={`transition-all duration-700 ${isVisible('why-content') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">{t('kel.whyTitle')}</h2>
              <p className="text-zinc-500 text-sm leading-relaxed mb-6 text-justify">
                {t('kel.whyDesc1')}
              </p>
              <p className="text-zinc-500 text-sm leading-relaxed mb-6">{t('kel.whyDesc2')}</p>
        ...
        <section id="treatment" className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="treatment-header" className={`max-w-2xl mb-12 transition-all duration-700 ${isVisible('treatment-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('kel.treatmentTitle')}</h2>
              <p className="text-zinc-500 text-sm">{t('kel.treatmentDesc')}</p>
            </div>
        ...
        <section className="py-8 md:py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-animate="safety-image" className={`relative rounded-2xl overflow-hidden aspect-[4/5] shadow-2xl order-2 lg:order-1 img-zoom hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] transition-all duration-700 ${isVisible('safety-image') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <div className="absolute bottom-8 right-8 bg-white p-6 rounded-xl shadow-xl border border-zinc-100 max-w-[260px] animate-float">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-bold text-zinc-900">{t('kel.importantNote')}</span>
                </div>
                <p className="text-xs text-zinc-500 leading-relaxed">
                  {t('kel.importantNoteDesc')}
                </p>
              </div>
            </div>
            ...
            <div data-animate="safety-content" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('safety-content') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">{t('kel.safetyTitle')}</h2>
              <p className="text-zinc-500 text-sm leading-relaxed mb-8">
                {t('kel.safetyDesc')}
              </p>

              <div className="mb-8">
                <h4 className="text-sm font-bold text-zinc-900 mb-4">{t('kel.tempEffectsTitle')}</h4>
              ...
              <div className="p-6 bg-orange-50/50 rounded-xl border border-orange-100">
                <h4 className="text-sm font-bold text-zinc-900 mb-3">{t('kel.timelineTitle')}</h4>
                <ul className="space-y-2 text-sm text-zinc-600">
                  {[t('kel.timeline1'), t('kel.timeline2'), t('kel.timeline3'), t('kel.timeline4')].map((item, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="candidate-header" className={`max-w-2xl mx-auto text-center mb-12 transition-all duration-700 ${isVisible('candidate-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('kel.candidateTitle')}</h2>
              <p className="text-zinc-500 text-sm">{t('kel.candidateDesc')}</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-1">
              <div data-animate="pricing" className={`bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl lg:sticky lg:top-24 shadow-2xl transition-all duration-700 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] group card-shine ${isVisible('pricing') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-[#FE7623] transition-colors duration-300">{t('kel.pricingTitle')}</h3>
                </div>
                <p className="text-zinc-400 text-sm mb-6">{t('kel.pricingDesc')}</p>
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-[#FE7623]">{t('kel.faqTitle')}</h2>
                  <p className="text-sm text-zinc-500">{t('kel.faqDesc')}</p>
                </div>
              </div>
              <div className="space-y-3">
                {faqs.map((faq, index) => (
        ...
        <section className="pt-12 md:pt-16 pb-8 md:pb-20 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-row items-start gap-3 mb-10">
              ...
              <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-widest flex-1">{t('kel.refTitle')}</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: "U.S. FDA", url: "https://www.fda.gov/", desc: t('kel.ref1Desc'), color: "from-blue-500 to-blue-600" },
                { name: "Mayo Clinic", url: "https://www.mayoclinic.org/diseases-conditions/keloid-scar/symptoms-causes/syc-20520901", desc: t('kel.ref2Desc'), color: "from-red-500 to-red-600" },
                { name: "NCBI / PubMed", url: "https://pubmed.ncbi.nlm.nih.gov/", desc: t('kel.ref3Desc'), color: "from-green-500 to-green-600" }
              ].map((source, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 relative overflow-hidden">
          ...
          <div data-animate="cta" className={`max-w-3xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-4xl font-semibold tracking-tight text-[#FE7623] mb-6 transition-colors duration-300 cursor-default">{t('kel.ctaTitle')}</h2>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-3">
              {[t('kel.tag1'), t('kel.tag2'), t('kel.tag3'), t('kel.tag4'), t('kel.tag5'), t('kel.tag6')].map((tag, i) => (

...
export default function BodyLiftMalaysia() {
  ...
  const faqs = [
    { question: t('bodyLift.faq1Q'), answer: t('bodyLift.faq1A') },
    { question: t('bodyLift.faq2Q'), answer: t('bodyLift.faq2A') },
    { question: t('bodyLift.faq3Q'), answer: t('bodyLift.faq3A') },
    { question: t('bodyLift.faq4Q'), answer: t('bodyLift.faq4A') },
    { question: t('bodyLift.faq5Q'), answer: t('bodyLift.faq5A') },
    { question: t('bodyLift.faq6Q'), answer: t('bodyLift.faq6A') },
    { question: t('bodyLift.faq7Q'), answer: t('bodyLift.faq7A') },
    { question: t('bodyLift.faq8Q'), answer: t('bodyLift.faq8A') }
  ]

  const areasAddressed = [
    { name: t('bodyLift.area1'), icon: "M12 2v20M8 6l4-4 4 4M8 18l4 4 4-4" },
    { name: t('bodyLift.area2'), icon: "M8 3L4 7l4 4M4 7h16m4 10l-4 4-4-4M20 17H4" },
    { name: t('bodyLift.area3'), icon: "M12 12m-10 0a10 10 0 1 0 20 0 10 10 0 1 0-20 0M12 12m-1 0a1 1 0 1 0 2 0 1 1 0 1 0-2 0" },
    { name: t('bodyLift.area4'), icon: "M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2M7 12h10" },
    { name: t('bodyLift.area5'), icon: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2M12 7m-4 0a4 4 0 1 0 8 0 4 4 0 1 0-8 0" }
  ]

  const skinLaxityCauses = [
    { title: t('bodyLift.laxity1Title'), desc: t('bodyLift.laxity1Desc') },
    { title: t('bodyLift.laxity2Title'), desc: t('bodyLift.laxity2Desc') },
    { title: t('bodyLift.laxity3Title'), desc: t('bodyLift.laxity3Desc') },
    { title: t('bodyLift.laxity4Title'), desc: t('bodyLift.laxity4Desc') },
    { title: t('bodyLift.laxity5Title'), desc: t('bodyLift.laxity5Desc') },
    { title: t('bodyLift.laxity6Title'), desc: t('bodyLift.laxity6Desc') }
  ]

  const bodyLiftTypes = [
    {
      title: t('bodyLift.type1Title'),
      desc: t('bodyLift.type1Desc'),
      highlight: true
    },
    {
      title: t('bodyLift.type2Title'),
      desc: t('bodyLift.type2Desc'),
      highlight: false
    },
    {
      title: t('bodyLift.type3Title'),
      desc: t('bodyLift.type3Desc'),
      highlight: false
    },
    {
      title: t('bodyLift.type4Title'),
      desc: t('bodyLift.type4Desc'),
      highlight: false
    }
  ]

  const candidateChecklist = [
    t('bodyLift.candidate1'),
    t('bodyLift.candidate2'),
    t('bodyLift.candidate3'),
    t('bodyLift.candidate4'),
    t('bodyLift.candidate5')
  ]
  ...
  const benefits = [
    { title: t('bodyLift.benefit1Title'), desc: t('bodyLift.benefit1Desc') },
    { title: t('bodyLift.benefit2Title'), desc: t('bodyLift.benefit2Desc') },
    { title: t('bodyLift.benefit3Title'), desc: t('bodyLift.benefit3Desc') },
    { title: t('bodyLift.benefit4Title'), desc: t('bodyLift.benefit4Desc') },
    { title: t('bodyLift.benefit5Title'), desc: t('bodyLift.benefit5Desc') },
    { title: t('bodyLift.benefit6Title'), desc: t('bodyLift.benefit6Desc') }
  ]
    ...
    <>
      ...
      <main className="bodylift-page bg-white text-zinc-900 overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">{t('bodyLift.heroTitle')}</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">{t('bodyLift.heroSubtitle')}</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>{t('bodyLift.heroDesc1')}</p>
                <p style={{fontSize: '14px', marginTop: '12px'}}>{t('bodyLift.heroDesc2')}</p>
                <p style={{fontSize: '14px', marginTop: '12px'}}>{t('bodyLift.heroDesc3')}</p>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8 animate-fadeInUp opacity-0" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
                ...
                <span className="text-sm text-zinc-600 font-medium">{t('bodyLift.trustedBy')} <span className="text-[#FE7623] font-bold">500+</span> {t('bodyLift.happyPatients')}</span>
              </div>
            </div>
              ...
              <div className="hidden md:block absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-[10px] md:text-xs font-bold uppercase tracking-wide text-zinc-400">{t('bodyLift.procedureFocus')}</p>
                      <p className="text-sm md:text-base font-semibold text-zinc-900">{t('bodyLift.circumferentialContouring')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              <div data-animate="def-1" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6 text-center md:text-left">{t('bodyLift.whatTitle')}</h2>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6 text-justify">
                  {t('bodyLift.whatDesc1')}
                </p>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6 text-justify">
                  {t('bodyLift.whatDesc2')}
                </p>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3 text-sm text-zinc-700 p-3 bg-zinc-50 rounded-lg border border-zinc-100 hover:border-[#FE7623] hover:bg-orange-50/30 transition-all duration-300 cursor-pointer group">
                    ...
                    <span dangerouslySetInnerHTML={{ __html: t('bodyLift.whatNotPoint') }} />
                  </div>
                  <div className="flex items-center gap-3 text-sm text-zinc-700 p-3 bg-orange-50 rounded-lg border border-orange-100 hover:border-[#FE7623] transition-all duration-300 cursor-pointer group">
                    ...
                    <span dangerouslySetInnerHTML={{ __html: t('bodyLift.whatYesPoint') }} />
                  </div>
                </div>
              </div>
              ...
              <div data-animate="def-2" className={`md:col-span-6 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6 text-center md:text-left">{t('bodyLift.whyTitle')}</h3>
        ...
        <section className="py-8 md:py-16 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="areas-header" className={`text-center mb-12 transition-all duration-700 ${isVisible('areas-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('bodyLift.areasTitle')}</h2>
              <p className="text-zinc-500 text-sm max-w-2xl mx-auto">{t('bodyLift.areasDesc')}</p>
            </div>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="process-header" className={`max-w-2xl mb-12 transition-all duration-700 ${isVisible('process-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4 text-center md:text-left">{t('bodyLift.processMainTitle')}</h2>
              <p className="text-zinc-500 text-sm text-center md:text-left">{t('bodyLift.processMainDesc')}</p>
            </div>

            <div className="border-t border-zinc-200 pt-12">
              <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-10 text-center">{t('bodyLift.processTitle')}</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 text-center relative">
                ...
                {[
                  { num: "1", title: t('bodyLift.processStep1'), desc: t('bodyLift.processStep1Desc') },
                  { num: "2", title: t('bodyLift.processStep2'), desc: t('bodyLift.processStep2Desc') },
                  { num: "3", title: t('bodyLift.processStep3'), desc: t('bodyLift.processStep3Desc') },
                  { num: "4", title: t('bodyLift.processStep4'), desc: t('bodyLift.processStep4Desc') },
                  { num: "5", title: t('bodyLift.processStep5'), desc: t('bodyLift.processStep5Desc') },
                  { num: "6", title: t('bodyLift.processStep6'), desc: t('bodyLift.processStep6Desc') }
                ].map((step, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div data-animate="types-header" className={`text-center mb-12 transition-all duration-700 ${isVisible('types-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight mb-4">{t('bodyLift.typesTitle')}</h2>
              <p className="text-zinc-400 text-sm max-w-2xl mx-auto">{t('bodyLift.typesDesc')}</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {bodyLiftTypes.map((type, i) => (
                <div key={i} data-animate={`type-${i}`} className={`p-8 rounded-2xl bg-zinc-800/50 border border-zinc-700/50 hover:bg-zinc-800 hover:border-[#FE7623]/50 transition-all duration-300 group ${type.highlight ? 'animate-border-glow' : ''} ${isVisible(`type-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  ...
                  {type.highlight && (
                    <span className="inline-block mt-4 px-3 py-1 bg-[#FE7623]/20 text-[#FE7623] text-xs font-semibold rounded-full">{t('bodyLift.mostCommon')}</span>
                  )}
                </div>
              ))}
            </div>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="benefits-header" className={`text-center mb-12 transition-all duration-700 ${isVisible('benefits-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('bodyLift.benefitsTitle')}</h2>
              <p className="text-zinc-500 text-sm max-w-2xl mx-auto">{t('bodyLift.benefitsDesc')}</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-animate="candidate-image" className={`relative rounded-2xl overflow-hidden aspect-[4/5] shadow-2xl order-2 lg:order-1 img-zoom hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] transition-all duration-700 ${isVisible('candidate-image') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="absolute bottom-8 right-8 bg-white p-6 rounded-xl shadow-xl border border-zinc-100 max-w-[260px] animate-float">
                <div className="mb-2">
                  <span className="text-sm font-bold text-zinc-900">{t('bodyLift.floatingBadge')}</span>
                </div>
                <p className="text-xs text-zinc-500 leading-relaxed">
                  {t('bodyLift.floatingBadgeDesc')}
                </p>
              </div>
            </div>
            ...
            <div data-animate="candidate-content" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('candidate-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6 text-center md:text-left">{t('bodyLift.candidateTitle')}</h2>
              <p className="text-zinc-500 text-sm leading-relaxed mb-8 text-center md:text-left">
                {t('bodyLift.candidateDesc')}
              </p>

              <div className="mb-8">
                <h4 className="text-sm font-bold text-zinc-900 mb-4 text-center md:text-left">{t('bodyLift.candidateChecklistTitle')}</h4>
              ...
              <div className="p-6 bg-red-50 rounded-xl border border-red-100">
                <h4 className="text-sm font-bold text-red-700 mb-4 text-center md:text-left">{t('bodyLift.notRecTitle')}</h4>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex flex-col w-full">
              <h2 data-animate="compare-header" className={`text-2xl font-semibold mb-4 text-center text-[#FE7623] transition-all duration-700 ${isVisible('compare-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('bodyLift.compareTitle')}</h2>
              <p className="text-zinc-500 text-sm text-center mb-10 max-w-2xl mx-auto">{t('bodyLift.compareDesc')}</p>
              ...
              <div data-animate="compare-table" className={`w-full border border-zinc-200 rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-500 ${isVisible('compare-table') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="grid grid-cols-3 bg-gradient-to-r from-zinc-50 to-orange-50/30 px-3 py-4 md:px-8 md:py-6 border-b border-zinc-200 text-[10px] sm:text-[11px] md:text-xs font-bold uppercase tracking-wider text-zinc-500 gap-2">
                  <div>{t('bodyLift.feature')}</div>
                  <div className="text-[#FE7623] flex items-center gap-2"><span className="hidden md:block w-2 h-2 rounded-full bg-[#FE7623] animate-pulse"></span>{t('bodyLift.compBodyLift')}</div>
                  <div>{t('bodyLift.compTummy')}</div>
                </div>

                {/* Rows */}
                {[
                  { feat: t('bodyLift.row1Feat'), lipo: t('bodyLift.row1BodyLift'), lipoIcon: true, tummy: t('bodyLift.row1Tummy') },
                  { feat: t('bodyLift.row2Feat'), lipo: t('bodyLift.row2BodyLift'), lipoIcon: true, tummy: t('bodyLift.row2Tummy') },
                  { feat: t('bodyLift.row3Feat'), lipo: t('bodyLift.row3BodyLift'), lipoIcon: true, tummy: t('bodyLift.row3Tummy'), tummyX: true },
                  { feat: t('bodyLift.row4Feat'), lipo: t('bodyLift.row4BodyLift'), lipoIcon: true, tummy: t('bodyLift.row4Tummy'), tummyX: true },
                  { feat: t('bodyLift.row5Feat'), lipo: t('bodyLift.row5BodyLift'), tummy: t('bodyLift.row5Tummy') }
                ].map((row, i) => (
                  <div key={i} className="grid grid-cols-3 px-3 py-4 md:px-8 md:py-6 border-b border-zinc-100 items-center text-[10px] sm:text-[11px] md:text-sm gap-2 hover:bg-gradient-to-r hover:from-orange-50/30 hover:to-white transition-all duration-300 group cursor-pointer">
                    ...
                    <div className={`flex items-center gap-1 md:gap-2 ${row.lipoIcon ? 'text-[#FE7623]' : 'text-[#FE7623]'}`}>
                      {row.lipoIcon && <svg className="hidden md:block w-4 h-4 md:w-6 md:h-6 group-hover:scale-125 transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}
                    ...
                    <div className="text-zinc-600 flex items-center gap-1 md:gap-2">
                      {row.tummyX && <svg className="hidden md:block w-4 h-4 md:w-6 md:h-6 text-zinc-400 group-hover:scale-110 transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>}
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div data-animate="recovery-header" className={`text-center mb-16 transition-all duration-700 ${isVisible('recovery-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('bodyLift.recoveryTitle')}</h2>
              <p className="text-zinc-500 text-sm">{t('bodyLift.recoveryDesc')}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pt-4">
              {[
                {
                  time: t('bodyLift.resTime1'),
                  title: t('bodyLift.resTitle1'),
                  points: [t('bodyLift.resPoint1a'), t('bodyLift.resPoint1b'), t('bodyLift.resPoint1c')],
                  icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"
                },
                {
                  time: t('bodyLift.resTime2'),
                  title: t('bodyLift.resTitle2'),
                  points: [t('bodyLift.resPoint2a'), t('bodyLift.resPoint2b'), t('bodyLift.resPoint2c')],
                  icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"
                },
                {
                  time: t('bodyLift.resTime3'),
                  title: t('bodyLift.resTitle3'),
                  points: [t('bodyLift.resPoint3a'), t('bodyLift.resPoint3b'), t('bodyLift.resPoint3c')],
                  icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"
                },
                {
                  time: t('bodyLift.resTime4'),
                  title: t('bodyLift.resTitle4'),
                  points: [t('bodyLift.resPoint4a'), t('bodyLift.resPoint4b'), t('bodyLift.resPoint4c')],
            ...
            <div className="lg:col-span-1">
              <div data-animate="pricing" className={`bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl lg:sticky lg:top-24 shadow-2xl transition-all duration-700 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] group card-shine ${isVisible('pricing') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex flex-col md:flex-row items-center md:items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-[#FE7623] transition-colors duration-300">{t('bodyLift.pricingTitle')}</h3>
                </div>
                <p className="text-zinc-400 text-sm mb-6 text-center md:text-left">{t('bodyLift.pricingDesc')}</p>
                <ul className="space-y-4 mb-8">
                  {[t('bodyLift.priceFactor1'), t('bodyLift.priceFactor2'), t('bodyLift.priceFactor3'), t('bodyLift.priceFactor4'), t('bodyLift.priceFactor5')].map((item, i) => (
            ...
            <div className="lg:col-span-2">
              <div className="flex flex-col md:flex-row items-center md:items-center gap-4 mb-8">
                ...
                <div className="text-center md:text-left">
                  <h2 className="text-2xl font-semibold text-[#FE7623]">{t('bodyLift.faqTitle')}</h2>
                  <p className="text-sm text-zinc-500">{t('bodyLift.faqDesc')}</p>
                </div>
              </div>
        ...
        <section className="py-8 md:py-20 px-6 bg-gradient-to-b from-zinc-50 to-white border-t border-zinc-200 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3 mb-10">
              <div className="p-2 bg-blue-50 rounded-lg animate-pulse-slow flex-shrink-0">
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
              </div>
              <div className="text-center md:text-left">
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-widest">{t('bodyLift.safetyTitle')}</h3>
                <p className="text-zinc-500 text-sm mt-1">{t('bodyLift.safetyDesc')}</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: t('bodyLift.safety1Name'), desc: t('bodyLift.safety1Desc'), color: "from-blue-500 to-blue-600", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
                { name: t('bodyLift.safety2Name'), desc: t('bodyLift.safety2Desc'), color: "from-green-500 to-green-600", icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
                { name: t('bodyLift.safety3Name'), desc: t('bodyLift.safety3Desc'), color: "from-purple-500 to-purple-600", icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" }
              ].map((source, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white relative overflow-hidden w-full">
          ...
          <div data-animate="cta" className={`max-w-3xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight text-[#FE7623] mb-6 transition-colors duration-300 cursor-default px-4">{t('bodyLift.ctaTitle')}</h2>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-3">
              {[t('bodyLift.seoTag1'), t('bodyLift.seoTag2'), t('bodyLift.seoTag3'), t('bodyLift.seoTag4'), t('bodyLift.seoTag5')].map((tag, i) => (

...
export default function StomachLiposuctionMalaysia() {
  ...
  const faqs = [
    { question: t('stomachLipo.faq1Q'), answer: t('stomachLipo.faq1A') },
    { question: t('stomachLipo.faq2Q'), answer: t('stomachLipo.faq2A') },
    { question: t('stomachLipo.faq3Q'), answer: t('stomachLipo.faq3A') },
    { question: t('stomachLipo.faq4Q'), answer: t('stomachLipo.faq4A') },
    { question: t('stomachLipo.faq5Q'), answer: t('stomachLipo.faq5A') },
    { question: t('stomachLipo.faq6Q'), answer: t('stomachLipo.faq6A') }
  ]

  const treatmentAreas = [
    { name: t('stomachLipo.area1'), icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" },
    { name: t('stomachLipo.area2'), icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" },
    { name: t('stomachLipo.area3'), icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" },
    { name: t('stomachLipo.area4'), icon: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" }
  ]

  const benefits = [
    { title: t('stomachLipo.benefit1Title'), desc: t('stomachLipo.benefit1Desc'), icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
    { title: t('stomachLipo.benefit2Title'), desc: t('stomachLipo.benefit2Desc'), icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
    { title: t('stomachLipo.benefit3Title'), desc: t('stomachLipo.benefit3Desc'), icon: "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" },
    { title: t('stomachLipo.benefit4Title'), desc: t('stomachLipo.benefit4Desc'), icon: "M20 12H4" },
    { title: t('stomachLipo.benefit5Title'), desc: t('stomachLipo.benefit5Desc'), icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" },
    { title: t('stomachLipo.benefit6Title'), desc: t('stomachLipo.benefit6Desc'), icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" }
  ]

  const processSteps = [
    { num: "1", title: t('stomachLipo.step1'), desc: t('stomachLipo.step1Desc') },
    { num: "2", title: t('stomachLipo.step2'), desc: t('stomachLipo.step2Desc') },
    { num: "3", title: t('stomachLipo.step3'), desc: t('stomachLipo.step3Desc') },
    { num: "4", title: t('stomachLipo.step4'), desc: t('stomachLipo.step4Desc') },
    { num: "5", title: t('stomachLipo.step5'), desc: t('stomachLipo.step5Desc') }
  ]
    ...
    <>
      ...
      <main className="stomach-lipo-page bg-white text-zinc-900">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">{t('stomachLipo.heroTitle')}</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">{t('stomachLipo.heroSubtitle')}</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>{t('stomachLipo.heroDesc')}</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fadeInUp opacity-0" style={{animationDelay: '0.4s', animationFillMode: 'forwards'}}>
                <a href="https://wa.me/60142616007?text=Hi%2C%20I%27m%20interested%20in%20Stomach%20Liposuction%20treatment" className="btn-magnetic inline-flex justify-center items-center gap-2 bg-gradient-to-r from-[#FE7623] to-orange-500 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full text-sm font-semibold hover:from-[#e56010] hover:to-orange-400 transition-all duration-300 shadow-lg shadow-orange-500/20 group animate-glow">
                  {t('stomachLipo.bookConsultation')}
              ...
              <div className="flex items-center gap-4 mt-8 animate-fadeInUp opacity-0" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
                ...
                <span className="text-sm text-zinc-600 font-medium">{t('stomachLipo.trustedBy')} <span className="text-[#FE7623] font-bold">500+</span> {t('stomachLipo.happyPatients')}</span>
              </div>
            </div>
              ...
              <div className="hidden md:block absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-[10px] md:text-xs font-bold uppercase tracking-wide text-zinc-400">{t('stomachLipo.technology')}</p>
                      <p className="text-sm md:text-base font-semibold text-zinc-900">{t('stomachLipo.techName')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12">
              ...
              <div data-animate="def-2" className={`md:col-span-7 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6">{t('stomachLipo.areasTitle')}</h3>
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div data-animate="process" className={`transition-all duration-700 ${isVisible('process') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <h2 className="text-2xl font-semibold tracking-tight text-[#FE7623] mb-8">{t('stomachLipo.processTitle')}</h2>
            ...
            <div data-animate="timeline" className={`bg-zinc-900 text-white p-8 rounded-2xl shadow-xl h-fit card-3d transition-all duration-700 ${isVisible('timeline') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h3 className="text-xl font-semibold mb-6">{t('stomachLipo.resultsTitle')}</h3>
              <div className="space-y-8 relative">
                {/* Vertical Line */}
                <div className="absolute top-2 bottom-2 left-[7px] w-px bg-zinc-700"></div>

                {[
                  { time: t('stomachLipo.resultsTime1'), desc: t('stomachLipo.resultsDesc1'), active: true },
                  { time: t('stomachLipo.resultsTime2'), desc: t('stomachLipo.resultsDesc2'), active: false },
                  { time: t('stomachLipo.resultsTime3'), desc: t('stomachLipo.resultsDesc3'), active: false }
                ].map((item, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="benefits-header" className={`text-2xl font-semibold tracking-tight text-center text-[#FE7623] mb-12 transition-all duration-700 ${isVisible('benefits-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('stomachLipo.benefitsTitle')}</h2>
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-5xl mx-auto">
            <h2 data-animate="candidate-header" className={`text-2xl font-semibold text-center mb-12 text-[#FE7623] transition-all duration-700 ${isVisible('candidate-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('stomachLipo.candidateTitle')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div data-animate="candidate-good" className={`bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm card-3d transition-all duration-700 ${isVisible('candidate-good') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                <h3 className="text-lg font-bold text-zinc-900 mb-6">{t('stomachLipo.idealTitle')}</h3>
                <ul className="space-y-4">
                  {[t('stomachLipo.ideal1'), t('stomachLipo.ideal2'), t('stomachLipo.ideal3'), t('stomachLipo.ideal4'), t('stomachLipo.ideal5')].map((item, i) => (
              ...
              <div data-animate="candidate-bad" className={`bg-zinc-50 p-8 rounded-2xl border border-zinc-200/60 opacity-90 card-3d transition-all duration-700 ${isVisible('candidate-bad') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-lg font-bold text-zinc-900 mb-6">{t('stomachLipo.notSuitableTitle')}</h3>
                <ul className="space-y-4">
                  {[t('stomachLipo.notSuitable1'), t('stomachLipo.notSuitable2'), t('stomachLipo.notSuitable3')].map((item, i) => (
            ...
            <Link href="/body/tummy-tuck-malaysia" className="group block bg-white border border-zinc-200 rounded-2xl p-6 hover:border-[#FE7623] hover:shadow-lg transition-all duration-300">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-zinc-900 group-hover:text-[#FE7623] transition-colors">{t('stomachLipo.looseSkinTitle')}</h4>
                    <p className="text-sm text-zinc-500 mt-1">{t('stomachLipo.looseSkinDesc')}</p>
                  </div>
                </div>
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="recovery-header" className={`text-2xl font-semibold tracking-tight text-center text-[#FE7623] mb-16 transition-all duration-700 ${isVisible('recovery-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('stomachLipo.recoveryTitle')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 text-center relative">
              ...
              {[
                { time: t('stomachLipo.recTime1'), title: t('stomachLipo.recTitle1'), desc: t('stomachLipo.recDesc1'), icon: true },
                { time: t('stomachLipo.recTime2'), title: t('stomachLipo.recTitle2'), desc: t('stomachLipo.recDesc2') },
                { time: t('stomachLipo.recTime3'), title: t('stomachLipo.recTitle3'), desc: t('stomachLipo.recDesc3') },
                { time: t('stomachLipo.recTime4'), title: t('stomachLipo.recTitle4'), desc: t('stomachLipo.recDesc4') },
                { time: t('stomachLipo.recTime5'), title: t('stomachLipo.recTitle5'), desc: t('stomachLipo.recDesc5') }
              ].map((step, i) => (
        ...
        <section className="py-12 md:py-24 px-6 bg-gradient-to-b from-zinc-50 to-white border-t border-zinc-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-row items-start gap-3 mb-10">
              ...
              <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-widest flex-1">{t('stomachLipo.refTitle')}</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: t('stomachLipo.harvardName'), url: "https://www.health.harvard.edu/", desc: t('stomachLipo.harvardDesc'), color: "from-red-500 to-red-600" },
                { name: t('stomachLipo.mayoName'), url: "https://www.mayoclinic.org/", desc: t('stomachLipo.mayoDesc'), color: "from-blue-500 to-blue-600" },
                { name: t('stomachLipo.pubmedName'), url: "https://pubmed.ncbi.nlm.nih.gov/", desc: t('stomachLipo.pubmedDesc'), color: "from-green-500 to-green-600" }
              ].map((source, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-[#FE7623]">{t('stomachLipo.faqTitle')}</h2>
                <p className="text-sm text-zinc-500">{t('stomachLipo.faqDesc')}</p>
              </div>
            </div>

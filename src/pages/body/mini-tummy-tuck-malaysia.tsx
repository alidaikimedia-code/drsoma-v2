...
export default function MiniTummyTuckMalaysia() {
  ...
  return (
    <>
      <Head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "@id": "https://drsomaplasticsurgery.com/body/mini-tummy-tuck-malaysia/#faq", "mainEntity": [{"@type": "Question", "name": "What is a mini tummy tuck?", "acceptedAnswer": {"@type": "Answer", "text": "A mini tummy tuck is a surgical procedure that removes loose skin from the lower abdomen and may tighten lower abdominal muscles without repositioning the belly button."}}, {"@type": "Question", "name": "How is a mini tummy tuck different from a full tummy tuck?", "acceptedAnswer": {"@type": "Answer", "text": "A mini tummy tuck treats only the lower abdomen with a smaller incision, while a full tummy tuck addresses the entire abdomen and includes full muscle repair."}}, {"@type": "Question", "name": "Is a mini tummy tuck safe?", "acceptedAnswer": {"@type": "Answer", "text": "When performed by a certified plastic surgeon in a regulated medical facility, it is considered a safe and well-established procedure."}}, {"@type": "Question", "name": "How long is recovery after a mini tummy tuck?", "acceptedAnswer": {"@type": "Answer", "text": "Most patients return to normal daily activities within 1–2 weeks, with final results developing over 2–3 months."}}, {"@type": "Question", "name": "Will there be a scar?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, but the scar is shorter than a full tummy tuck and placed low on the abdomen, usually hidden by underwear or swimwear."}}, {"@type": "Question", "name": "Are results permanent?", "acceptedAnswer": {"@type": "Answer", "text": "Results are long-lasting as long as body weight remains stable."}}, {"@type": "Question", "name": "Can a mini tummy tuck fix muscle separation?", "acceptedAnswer": {"@type": "Answer", "text": "Only mild lower-abdominal muscle laxity can be corrected. Significant separation usually requires a full tummy tuck."}}, {"@type": "Question", "name": "Who is an ideal candidate?", "acceptedAnswer": {"@type": "Answer", "text": "Patients with mild lower-abdominal skin looseness, stable weight, and realistic expectations."}}, {"@type": "Question", "name": "Can it be combined with liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, it is commonly combined for improved contouring when appropriate."}}, {"@type": "Question", "name": "Does a mini tummy tuck change the belly button?", "acceptedAnswer": {"@type": "Answer", "text": "No, the belly button is not repositioned."}}]})
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "@id": "https://drsomaplasticsurgery.com/body/mini-tummy-tuck-malaysia/#service", "name": "Mini Tummy Tuck Malaysia by Specialist Plastic Surgeon | Lower Abdomen Tightening – Dr. Soma", "url": "https://drsomaplasticsurgery.com/body/mini-tummy-tuck-malaysia/", "description": "Looking for mini tummy tuck in Malaysia? Dr. Soma offers targeted lower-abdominal tightening with a smaller incision for faster recovery and natural results.", "aggregateRating": {"@type": "AggregateRating", "ratingValue": 4.9, "reviewCount": 127}})
          }}
        />
      </Head>

      <style jsx global>{`
        .mini-tummy-page ::selection {
      ...
      <main className="mini-tummy-page bg-white text-zinc-900">
        {/* Hero Section */}
        <section className="relative pt-[50px] pb-[50px] md:pt-[60px] md:pb-[60px] px-6 overflow-hidden" style={{backgroundColor: '#F8FAFC'}}>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-2 relative rounded-2xl overflow-hidden aspect-[3/2] md:aspect-[4/3] group animate-fadeInRight opacity-0 img-zoom transition-all duration-500" style={{animationDelay: '0.3s', animationFillMode: 'forwards', boxShadow: '0 10px 40px -10px rgba(0,0,0,0.3), 0 0 20px rgba(0,0,0,0.1)'}}>
              <BaseImage
                src="/images/tumy.jpg"
                alt="Mini Tummy Tuck in Malaysia"
                fill
                ...
                {[
                  ...
                  <div key={i} className="grid grid-cols-3 px-2 py-3 md:px-8 md:py-6 border-b border-zinc-100 items-center text-[10px] sm:text-[11px] md:text-sm gap-3 md:gap-4 hover:bg-gradient-to-r hover:from-orange-50/30 hover:to-white transition-all duration-300 group cursor-pointer">
                    ...
                    <div className={`flex items-center gap-1 md:gap-2 ${row.miniIcon ? 'text-[#FE7623]' : row.miniX ? 'text-zinc-400' : 'text-[#FE7623]'}`}>
                      ...
                      {row.miniX && <svg className="w-4 h-4 md:w-6 md:h-6 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>}
                      <span className="group-hover:font-semibold transition-all duration-300">{row.mini}</span>
                    </div>
                    <div className="text-zinc-600 flex items-center gap-1 md:gap-2">
                      {row.fullIcon && <svg className="w-4 h-4 md:w-6 md:h-6 text-green-500 group-hover:scale-125 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>}
                      {row.fullX && <svg className="w-4 h-4 md:w-6 md:h-6 text-zinc-400 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>}
                      <span className="group-hover:text-zinc-900 transition-colors duration-300">{row.full}</span>
                    </div>
                  </div>
                ))}
              </div>

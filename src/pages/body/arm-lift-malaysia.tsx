  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-2 bg-white border border-orange-100 px-4 py-1.5 rounded-full shadow-sm">
                <span className="w-2 h-2 rounded-full bg-primary"></span>
                <span className="text-xs font-semibold text-primary tracking-widest uppercase">ARM LIFT IN MALAYSIA</span>
              </div>

              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-zinc-900 leading-[1.1] tracking-tight">
                Brachioplasty for Firmer, <span className="text-primary">Contoured Upper Arms</span>
              </h1>

              <p className="text-lg text-zinc-900 font-medium border-l-4 border-primary pl-6">
                Performed by a Certified Plastic Surgeon
              </p>

              <div className="prose prose-zinc text-zinc-600 max-w-lg">
                <p>
              ...
              {/* Regulation Box */}
              <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-lg shadow-zinc-200/50">
              ...
              <div className="space-y-4">
                ...
                <a href="#" className="inline-flex items-center gap-2 bg-zinc-900 text-white px-6 py-3 rounded-xl font-semibold hover:bg-zinc-800 transition-all shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Hero Image */}
            <div className="relative h-full min-h-[500px] lg:h-[650px] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              <BaseImage src="/images/armlift.jpg" alt="Arm Lift Surgery Malaysia" width={800} height={650} className="absolute inset-0 w-full h-full object-cover" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto space-y-8">
            <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight">What Is an Arm Lift (Brachioplasty)?</h2>
            ...
            <div className="bg-orange-50/50 p-6 rounded-xl border-l-4 border-primary">
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight mb-12 text-center">How Arm Lift Surgery Is Performed</h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-100 hover:border-orange-200 transition-colors group">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight mb-12">Types of Arm Lift Procedures</h2>

          <div className="grid lg:grid-cols-3 gap-8">
            {/* Mini */}
            <div className="bg-zinc-50 rounded-2xl p-8 border border-zinc-100 hover:shadow-lg transition-all">
          ...
          <p className="mt-8 text-zinc-500 text-sm">The appropriate technique is selected based on anatomy and goals.</p>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-50 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight mb-4">Results and Recovery Timeline</h2>
            <p className="text-zinc-600">Expected recovery progression:</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid gap-6 md:gap-8">
              ...
              <div className="flex items-start gap-4 md:gap-6 relative">
                ...
                <div className="flex-1 px-5 py-6 md:px-6 md:py-8 rounded-xl border border-zinc-200 bg-white shadow-sm">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight mb-8">Benefits of an Arm Lift</h2>
              <ul className="space-y-4">
                <li className="flex items-start gap-4 p-4 rounded-xl hover:bg-zinc-50 transition-colors border border-transparent hover:border-zinc-100">
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=2070&auto=format&fit=crop" alt="Fit woman arms" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-semibold tracking-tight mb-12 text-center">Who Is a Good Candidate?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Note */}
            <div className="bg-zinc-800 p-8 rounded-2xl border border-zinc-700 flex flex-col justify-center">
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center text-white">
          <h2 className="text-3xl font-semibold mb-6">Arm Lift and Liposuction</h2>
          <p className="text-lg text-orange-50 leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-semibold text-zinc-900 tracking-tight mb-12 text-center">Post-Surgery Aftercare</h2>
          ...
          <p className="mt-8 text-center text-zinc-500 text-sm">After arm lift surgery, following these guidelines is crucial for optimal healing.</p>
        </div>
      </section>
      ...
      <section className="py-50 lg:py-100 bg-white">
        <div className="containers">
          <h2 className="text-primary md:text-start text-center max-[512px]:!text-[34px] mb-16 lg:mb-20">
          ...
          <div className="flex w-full flex-col gap-[6px]">
            {faqData.map((item, index) => (
              <div
                key={index}
                className="w-full border border-stroke bg-para-white rounded-[12px] py-[14px] px-[24px] md:py-[18px] md:px-[32px]"
              >
                <div
      ...
      <section className="py-24 bg-zinc-50 border-t border-zinc-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-zinc-900 tracking-tight mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#" className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-[#25D366] text-white font-semibold rounded-xl hover:bg-[#20bd5a] transition-all shadow-lg shadow-green-500/20">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>
              </svg>
              Chat with Us on WhatsApp
            </a>
            <a href="#" className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-orange-600 transition-all shadow-lg shadow-primary/20">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="18" height="18" x="3" y="4" rx="2" ry="2"/>
                <line x1="16" x2="16" y1="2" y2="6"/>
                <line x1="8" x2="8" y1="2" y2="6"/>

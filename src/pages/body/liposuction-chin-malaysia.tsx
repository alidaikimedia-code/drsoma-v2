  ...
  return (
    <>
      ...
      <main className="chin-lipo-page bg-white text-zinc-900">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                ...
                <span className="text-zinc-400 hover:text-[#FE7623] transition-colors duration-300 cursor-default">Sharper Jawline. Cleaner Neck Angle.</span>
              </h1>
              <p className="text-lg text-zinc-500 leading-relaxed mb-6 max-w-lg animate-fadeInUp opacity-0" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                A double chin can appear even in slim patients. Genetics and facial structure can soften the neck angle, making the face look heavier. We refine the jawline using controlled sculpting for natural definition.
              </p>
              <p className="text-sm text-zinc-500 leading-relaxed mb-8 max-w-lg border-l-2 border-[#FE7623] pl-4 animate-fadeInUp opacity-0" style={{animationDelay: '0.35s', animationFillMode: 'forwards'}}>
                At Dr. Soma Plastic Surgery, every procedure is performed by Dr. Soma with a focus on <strong className="text-zinc-700">subtle precision, symmetry, and a natural jawline definition</strong> that looks like you, just sharper.
              </p>
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-white p-4 rounded-xl border border-zinc-200 shadow-lg flex items-center gap-4 group-hover:translate-y-[-5px] transition-transform duration-500">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-black">Natural Jawline Definition</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
              <div data-animate="def-1" className={`md:col-span-5 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-zinc-900 mb-6">What Is Chin Liposuction?</h2>
              ...
              <div data-animate="def-2" className={`md:col-span-7 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-6">Common Treatment Zones</h3>
        ...
        <section className="py-24 px-6 bg-zinc-50 border-t border-zinc-200">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div data-animate="method" className={`transition-all duration-700 ${isVisible('method') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-zinc-900 mb-6">How Chin Liposuction Works</h2>
              ...
              <h3 className="text-xl font-semibold tracking-tight text-zinc-900 mb-6">When Will I See Results?</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Image 1 */}
            <div data-animate="img-1" className={`relative rounded-2xl overflow-hidden shadow-2xl h-[600px] lg:sticky lg:top-8 transition-all duration-700 ${isVisible('img-1') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <BaseImage
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="benefits-header" className={`text-3xl font-semibold tracking-tight text-center text-zinc-900 mb-12 transition-all duration-700 ${isVisible('benefits-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>Benefits of Chin Liposuction</h2>
        ...
        <section className="py-24 px-6 bg-zinc-900 text-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-animate="usp" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('usp') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-white mb-8">What Makes Dr. Soma&apos;s Chin Liposuction Different?</h2>
              ...
              <div className="mt-10 pt-8 border-t border-zinc-800">
                <a href="https://wa.me/60142616007" className="inline-flex items-center gap-2 text-sm font-semibold text-[#FE7623] hover:text-white transition-colors group">
          ...
          <div className="flex containers w-full">
            <div className="flex flex-col w-full">
              <div data-animate="comparison" className={`w-full transition-all duration-700 ${isVisible('comparison') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <h2 className="text-2xl font-semibold mb-10 text-center">Chin Liposuction vs Non-Surgical</h2>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div data-animate="recovery" className={`transition-all duration-700 ${isVisible('recovery') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-zinc-900 mb-8">Post-Operative Recovery</h2>
        ...
        <section className="py-24 px-6 bg-white relative overflow-hidden">
          ...
          <div data-animate="cta" className={`max-w-3xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-zinc-900 mb-6 hover:text-[#FE7623] transition-colors duration-300 cursor-default">Refine your jawline with surgeon-performed liposuction.</h2>

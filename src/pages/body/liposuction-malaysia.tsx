...
export default function LiposuctionMalaysia() {
  ...
  const faqs = [
    { question: t('lipo.faq1Q'), answer: t('lipo.faq1A') },
    { question: t('lipo.faq2Q'), answer: t('lipo.faq2A') },
    { question: t('lipo.faq3Q'), answer: t('lipo.faq3A') },
    { question: t('lipo.faq4Q'), answer: t('lipo.faq4A') },
    { question: t('lipo.faq5Q'), answer: t('lipo.faq5A') },
    { question: t('lipo.faq6Q'), answer: t('lipo.faq6A') },
    { question: t('lipo.faq7Q'), answer: t('lipo.faq7A') },
    { question: t('lipo.faq8Q'), answer: t('lipo.faq8A') },
    { question: t('lipo.faq9Q'), answer: t('lipo.faq9A') },
    { question: t('lipo.faq10Q'), answer: t('lipo.faq10A') },
    { question: t('lipo.faq11Q'), answer: t('lipo.faq11A') },
    { question: t('lipo.faq12Q'), answer: t('lipo.faq12A') },
    { question: t('lipo.faq13Q'), answer: t('lipo.faq13A') },
    { question: t('lipo.faq14Q'), answer: t('lipo.faq14A') },
  ]

  const treatmentAreas = [
    { icon: "user", name: t('lipo.areaAbdomen') },
    { icon: "move-horizontal", name: t('lipo.areaFlanks') },
    { icon: "maximize", name: t('lipo.areaThighs') },
    { icon: "smile", name: t('lipo.areaChinJaw') },
    { icon: "shirt", name: t('lipo.areaArms') },
    { icon: "layers", name: t('lipo.areaBack') },
    { icon: "activity", name: t('lipo.areaChest') },
    { icon: "circle", name: t('lipo.areaHips') }
  ]

  const techniques = [
    {
      title: t('lipo.palTitle'),
      desc: t('lipo.palDesc'),
      features: [t('lipo.palFeat1'), t('lipo.palFeat2'), t('lipo.palFeat3')],
      highlight: true
    },
    {
      title: t('lipo.miniTitle'),
      desc: t('lipo.miniDesc'),
      features: [t('lipo.miniFeat1'), t('lipo.miniFeat2'), t('lipo.miniFeat3')],
      highlight: false
    },
    {
      title: t('lipo.largeTitle'),
      desc: t('lipo.largeDesc'),
      features: [t('lipo.largeFeat1'), t('lipo.largeFeat2'), t('lipo.largeFeat3')],
      highlight: false
    }
  ]
    ...
    <>
      <Head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "@id": "https://drsomaplasticsurgery.com/body/liposuction-malaysia/#faq", "mainEntity": [{"@type": "Question", "name": "What is liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "A surgical fat-removal procedure that contours and reshapes specific areas of the body by removing excess subcutaneous fat."}}, {"@type": "Question", "name": "How is liposuction done?", "acceptedAnswer": {"@type": "Answer", "text": "Small incisions are made, a fine cannula is inserted, and fat is suctioned out using MicroAire Power-Assisted technology for smoother results and reduced trauma."}}, {"@type": "Question", "name": "When will I see results after liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "You'll start noticing changes at 4–6 weeks, with the final shape visible between 3–6 months as swelling subsides."}}, {"@type": "Question", "name": "How long does liposuction last?", "acceptedAnswer": {"@type": "Answer", "text": "Results are long-lasting because fat cells removed do not regenerate. Maintaining stable weight preserves contour."}}, {"@type": "Question", "name": "Can I lose 10 kg with liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "No. Liposuction is not for weight loss. It removes volume and contours the body, not kilograms."}}, {"@type": "Question", "name": "How painful is liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Pain is usually mild to moderate — similar to muscle soreness after an intense workout. Medication keeps discomfort manageable."}}, {"@type": "Question", "name": "Is liposuction good or bad for you?", "acceptedAnswer": {"@type": "Answer", "text": "When performed by a certified plastic surgeon, liposuction is safe, effective, and one of the most common aesthetic surgeries globally."}}, {"@type": "Question", "name": "What is the best age to get liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Most suitable for adults aged 20–60 with good skin elasticity."}}, {"@type": "Question", "name": "Is your stomach flat after liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Yes — if your main issue is excess fat. If loose skin is present, a Tummy Tuck may be recommended."}}, {"@type": "Question", "name": "How risky is stomach liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Risks are low when done by a trained surgeon in a hospital setting. Dr. Soma performs liposuction with full monitoring and controlled safety protocols."}}, {"@type": "Question", "name": "What body part is most painful for liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Areas with tighter skin (e.g., flanks or inner thighs) may feel slightly more sore, but pain is manageable."}}, {"@type": "Question", "name": "How long is bed rest after liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "You are encouraged to walk immediately after surgery. Most patients return to normal routines within 5–7 days."}}, {"@type": "Question", "name": "Do I need to lose weight before liposuction?", "acceptedAnswer": {"@type": "Answer", "text": "Not necessary — but being at a stable, healthy weight gives better contouring results."}}, {"@type": "Question", "name": "Does liposuction leave scars?", "acceptedAnswer": {"@type": "Answer", "text": "Only tiny (3–4mm) incisions hidden in natural creases. They fade significantly with time."}}]})
          }}
        />
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "@id": "https://drsomaplasticsurgery.com/body/liposuction-malaysia/#service", "name": "Liposuction Malaysia by Specialist Plastic Surgeon | Remove Stubborn Fat Safely – Dr. Soma", "url": "https://drsomaplasticsurgery.com/body/liposuction-malaysia/", "description": "Looking for safe, surgeon-performed liposuction in Malaysia? Dr. Soma offers advanced body contouring using MicroAire Power-Assisted Liposuction for long-lasting, natural results.", "aggregateRating": {"@type": "AggregateRating", "ratingValue": 4.9, "reviewCount": 127}})
          }}
        />
      </Head>

      <style jsx global>{`
        .liposuction-page ::selection { background-color: #FE7623; color: white; }
        @keyframes fadeInUp { from { opacity: 0; transform: translateY(30px); } to { opacity: 1; transform: translateY(0); } }
        @keyframes fadeInRight { from { opacity: 0; transform: translateX(30px); } to { opacity: 1; transform: translateX(0); } }
        @keyframes float { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-10px); } }
        @keyframes glow { 0%, 100% { box-shadow: 0 0 5px rgba(254, 118, 35, 0.2); } 50% { box-shadow: 0 0 20px rgba(254, 118, 35, 0.4); } }
        @keyframes progressBar { from { width: 0%; } to { width: 100%; } }
        @keyframes shimmer { 0% { background-position: -200% 0; } 100% { background-position: 200% 0; } }
        @keyframes pulse { 0%, 100% { transform: scale(1); opacity: 1; } 50% { transform: scale(1.05); opacity: 0.8; } }
        @keyframes bounce { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-5px); } }
        @keyframes borderGlow { 0%, 100% { border-color: rgba(254, 118, 35, 0.3); } 50% { border-color: rgba(254, 118, 35, 0.8); } }
        ...
        .card-hover:hover { transform: translateY(-8px); box-shadow: 0 20px 40px -15px rgba(254, 118, 35, 0.15); border-color: #FE7623; }
        .card-3d { transition: all 0.5s cubic-bezier(0.23, 1, 0.32, 1); transform-style: preserve-3d; }
        .card-3d:hover { transform: translateY(-10px) rotateX(5deg) rotateY(-5deg); box-shadow: 0 25px 50px -12px rgba(254, 118, 35, 0.25); }
        .card-shine { position: relative; overflow: hidden; }
        .card-shine::before { content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: linear-gradient(to bottom right, rgba(255,255,255,0) 0%, rgba(255,255,255,0) 40%, rgba(255,255,255,0.4) 50%, rgba(255,255,255,0) 60%, rgba(255,255,255,0) 100%); transform: rotate(45deg) translateX(-100%); transition: transform 0.6s; }
        ...
        .ripple::after { content: ''; position: absolute; top: 50%; left: 50%; width: 0; height: 0; background: rgba(254,118,35,0.2); border-radius: 50%; transform: translate(-50%,-50%); transition: width 0.6s, height 0.6s; }
      ...
      <main className="liposuction-page bg-white text-zinc-900">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="order-1 lg:order-1">
              ...
              <h1 className="text-4xl md:text-6xl font-semibold tracking-tighter text-zinc-900 leading-[1.05] mb-3 md:mb-6 animate-fadeInUp opacity-0" style={{animationDelay: '0.2s', animationFillMode: 'forwards'}}>
                <span className="hover:text-[#FE7623] transition-colors duration-300 cursor-default">{t('lipo.heroTitle')}</span> <br />
                <span className="text-[#FE7623] text-[20px] md:text-[30px] tracking-[1px] transition-colors duration-300 cursor-default mt-[10px] block">{t('lipo.heroSubtitle')}</span>
              </h1>
              <div className="text-zinc-600 leading-relaxed mb-4 md:mb-8 max-w-xl animate-fadeInUp opacity-0 text-justify" style={{animationDelay: '0.3s', animationFillMode: 'forwards'}}>
                <p style={{fontSize: '14px'}}>{t('lipo.heroDesc')}</p>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8 animate-fadeInUp opacity-0" style={{animationDelay: '0.5s', animationFillMode: 'forwards'}}>
                <div className="flex -space-x-2">
                  {['https://randomuser.me/api/portraits/women/44.jpg','https://randomuser.me/api/portraits/men/32.jpg','https://randomuser.me/api/portraits/women/68.jpg','https://randomuser.me/api/portraits/men/75.jpg','https://randomuser.me/api/portraits/women/89.jpg'].map((img, i) => (
                ...
                <span className="text-sm text-zinc-600 font-medium">{t('lipo.trustedBy')} <span className="text-[#FE7623] font-bold">500+</span> {t('lipo.happyPatients')}</span>
              </div>
            </div>
            ...
            <div className="order-2 lg:order-2 relative rounded-2xl overflow-hidden aspect-[3/2] md:aspect-[4/3] group animate-fadeInRight opacity-0 img-zoom transition-all duration-500" style={{animationDelay: '0.3s', animationFillMode: 'forwards', boxShadow: '0 10px 40px -10px rgba(0,0,0,0.3), 0 0 20px rgba(0,0,0,0.1)'}}>
              <BaseImage src="/images/Liposuction in Malaysia.jpg" alt="Liposuction in Malaysia" fill className="object-cover opacity-95" />
              ...
              <div className="hidden md:block absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                <div className="bg-white backdrop-blur-md p-3 md:p-5 rounded-xl border border-zinc-100 shadow-xl group-hover:translate-y-[-5px] transition-transform duration-500">
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-[10px] md:text-xs font-bold uppercase tracking-wide text-zinc-400">{t('lipo.technology')}</p>
                      <p className="text-sm md:text-base font-semibold text-zinc-900">{t('lipo.techName')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              <div data-animate="def-1" className={`md:col-span-5 transition-all duration-700 ${isVisible('def-1') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">{t('lipo.whatTitle')}</h2>
                <p className="text-zinc-500 text-sm leading-relaxed mb-6 text-justify">
                  {t('lipo.whatDesc')} <strong>{t('lipo.whatDescNot')}</strong> {t('lipo.whatDesc2')}
                </p>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3 text-sm text-zinc-700 p-3 bg-zinc-50 rounded-lg border border-zinc-100 hover:border-[#FE7623] hover:bg-orange-50/30 transition-all duration-300 cursor-pointer group">
                    ...
                    <span>{t('lipo.removesFat')}</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-zinc-700 p-3 bg-zinc-50 rounded-lg border border-zinc-100 hover:border-[#FE7623] hover:bg-orange-50/30 transition-all duration-300 cursor-pointer group">
                    <svg className="w-6 h-6 text-[#FE7623] group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <span>{t('lipo.enhancesBody')}</span>
                  </div>
                </div>
              </div>
              ...
              <div data-animate="def-2" className={`md:col-span-7 transition-all duration-700 ${isVisible('def-2') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
                <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-6">{t('lipo.areasTitle')}</h3>
        ...
        <section id="process" className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto">
            <div data-animate="tech-header" className={`max-w-2xl mb-12 transition-all duration-700 ${isVisible('tech-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('lipo.advancedTech')}</h2>
              <p className="text-zinc-500 text-sm">{t('lipo.techSelectDesc')}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
              {techniques.map((tech, i) => (
                <div key={i} data-animate={`tech-${i}`} className={`bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm card-3d card-shine ${tech.highlight ? 'animate-border-glow' : ''} ${isVisible(`tech-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 ${tech.highlight ? 'bg-gradient-to-br from-[#FE7623] to-orange-400 text-white animate-pulse-slow' : 'bg-zinc-100 text-zinc-900'} transition-all duration-500`}>
            ...
            <div className="border-t border-zinc-200 pt-16">
              <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-wide mb-10 text-center">{t('lipo.processTitle')}</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative">
                ...
                {[
                  { num: "1", title: t('lipo.step1'), desc: t('lipo.step1Desc') },
                  { num: "2", title: t('lipo.step2'), desc: t('lipo.step2Desc') },
                  { num: "3", title: t('lipo.step3'), desc: t('lipo.step3Desc') },
                  { num: "4", title: t('lipo.step4'), desc: t('lipo.step4Desc') }
                ].map((step, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-animate="why-image" className={`relative rounded-2xl overflow-hidden aspect-[4/5] shadow-2xl order-2 lg:order-1 img-zoom hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] transition-all duration-700 ${isVisible('why-image') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <BaseImage src="/images/Liposuction 2.jpg" alt="Dr. Soma Consultation" fill className="object-cover" />
              ...
              <div className="absolute bottom-8 right-8 bg-white p-6 rounded-xl shadow-xl border border-zinc-100 max-w-[260px] animate-float">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-bold text-zinc-900">{t('lipo.safetyFirst')}</span>
                </div>
                <p className="text-xs text-zinc-500 leading-relaxed">&ldquo;{t('lipo.safetyQuote')}&rdquo;</p>
              </div>
            </div>
            ...
            <div data-animate="why-content" className={`order-1 lg:order-2 transition-all duration-700 ${isVisible('why-content') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-6">{t('lipo.whyTitle')}</h2>
              <p className="text-zinc-500 text-sm leading-relaxed mb-8">{t('lipo.whyDesc')}</p>

              <div className="space-y-6">
                {[
                  { title: t('lipo.certifiedTitle'), desc: t('lipo.certifiedDesc') },
                  { title: t('lipo.symmetryTitle'), desc: t('lipo.symmetryDesc') },
                  { title: t('lipo.hospitalTitle'), desc: t('lipo.hospitalDesc') }
                ].map((item, i) => (
              ...
              <div className="mt-10 pt-10 border-t border-zinc-100">
                <h4 className="text-sm font-bold text-zinc-900 mb-4">{t('lipo.candidatesTitle')}</h4>
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50">
          <div className="max-w-7xl mx-auto w-full">
            <div className="flex flex-col w-full">
              <h2 data-animate="compare-header" className={`text-2xl font-semibold mb-10 text-center text-[#FE7623] transition-all duration-700 ${isVisible('compare-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('lipo.compareTitle')}</h2>
              <div data-animate="compare-table" className={`w-full border border-zinc-200 rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-500 ${isVisible('compare-table') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                {[
                  { feat: t('lipo.removesFatShort'), lipo: t('lipo.yes'), lipoIcon: true, tummy: t('lipo.yes'), tummyIcon: true },
                  { feat: t('lipo.tightensSkin'), lipo: t('lipo.no'), lipoX: true, tummy: t('lipo.yes'), tummyIcon: true },
                  { feat: t('lipo.repairMuscles'), lipo: t('lipo.no'), lipoX: true, tummy: t('lipo.yes'), tummyIcon: true },
                  { feat: t('lipo.downtime'), lipo: t('lipo.lipoDowntime'), tummy: t('lipo.tummyDowntime') }
                ].map((row, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            <div data-animate="recovery-header" className={`text-center mb-16 transition-all duration-700 ${isVisible('recovery-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-3xl font-semibold tracking-tight text-[#FE7623] mb-4">{t('lipo.recoveryTitle')}</h2>
              <p className="text-zinc-500 text-sm">{t('lipo.recoverySubtitle')}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
              {[
                { time: t('lipo.immAfter'), title: t('lipo.surgeryDay'), points: [t('lipo.surgeryDayP1'), t('lipo.surgeryDayP2'), t('lipo.surgeryDayP3')], icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
                { time: t('lipo.week1'), title: t('lipo.earlyRecovery'), points: [t('lipo.earlyP1'), t('lipo.earlyP2')], icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
                { time: t('lipo.week23'), title: t('lipo.healingPhase'), points: [t('lipo.healingP1'), t('lipo.healingP2')], icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
                { time: t('lipo.week46'), title: t('lipo.activeRecovery'), points: [t('lipo.activeP1'), t('lipo.activeP2')], icon: "M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
                { time: t('lipo.month36'), title: t('lipo.finalResults'), points: [t('lipo.finalP1'), t('lipo.finalP2')], icon: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" }
              ].map((step, i) => (
                <div key={i} data-animate={`recovery-${i}`} className={`relative bg-white pt-14 pb-8 px-8 rounded-2xl border border-zinc-200 shadow-sm card-3d overflow-visible hover:border-[#FE7623] group ${isVisible(`recovery-${i}`) ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{transitionDelay: `${i * 100}ms`}}>
                  <div className="absolute -top-4 left-6 px-7 py-2 bg-gradient-to-r from-[#FE7623] to-orange-400 text-white text-xs font-bold rounded-full shadow-lg group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-orange-500/30 transition-all duration-300 z-10">{step.time}</div>
                  <div className="w-14 h-14 rounded-xl bg-orange-50 flex items-center justify-center mb-6 group-hover:bg-gradient-to-br group-hover:from-[#FE7623] group-hover:to-orange-400 group-hover:scale-125 group-hover:rotate-12 group-hover:shadow-xl transition-all duration-500">
                    <svg className="w-7 h-7 text-[#FE7623] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={step.icon} /></svg>
                  </div>
                  ...
                  <ul className="space-y-3">
                    {step.points.map((point, j) => (
                      <li key={j} className="flex items-start gap-3 text-sm text-zinc-600 group-hover:text-zinc-800 hover:translate-x-2 transition-all duration-300">
                        <svg className="w-6 h-6 min-w-[24px] text-[#FE7623] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                        <span>{point}</span>
                      </li>
                    ))}
                  </ul>
            ...
            <div data-animate="recovery-progress" className={`mt-16 transition-all duration-700 ${isVisible('recovery-progress') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="bg-zinc-100 rounded-full h-3 overflow-hidden">
                <div className="h-full bg-gradient-to-r from-[#FE7623] to-orange-400 rounded-full w-0" style={{animation: 'progressBar 2s ease-out forwards', animationDelay: '0.5s'}}></div>
              </div>
              <div className="flex justify-between mt-4 text-xs text-zinc-500">
                <span>{t('lipo.day1')}</span>
                <span>{t('lipo.week1')}</span>
                <span>{t('lipo.week23')}</span>
                <span>{t('lipo.week46')}</span>
                <span>{t('lipo.month36')}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 md:py-24 px-6 bg-zinc-50 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <h2 data-animate="testimonial-header" className={`text-2xl font-semibold text-center mb-12 text-[#FE7623] transition-all duration-700 ${isVisible('testimonial-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>{t('lipo.storiesTitle')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { text: t('lipo.test1Text'), name: t('lipo.test1Name') },
                { text: t('lipo.test2Text'), name: t('lipo.test2Name') },
                { text: t('lipo.test3Text'), name: t('lipo.test3Name') }
              ].map((testimonial, i) => (
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            <div className="lg:col-span-1">
              <div data-animate="pricing" className={`bg-gradient-to-br from-zinc-900 to-zinc-800 text-white p-8 rounded-2xl lg:sticky lg:top-24 shadow-2xl transition-all duration-700 hover:shadow-[0_25px_60px_-15px_rgba(254,118,35,0.3)] group card-shine ${isVisible('pricing') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold group-hover:text-[#FE7623] transition-colors duration-300">{t('lipo.pricingTitle')}</h3>
                </div>
                <p className="text-zinc-400 text-sm mb-6">{t('lipo.pricingDesc')}</p>
                <ul className="space-y-4 mb-8">
                  {[t('lipo.priceFactor1'), t('lipo.priceFactor2'), t('lipo.priceFactor3'), t('lipo.priceFactor4')].map((item, i) => (
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-[#FE7623]">{t('lipo.faqTitle')}</h2>
                  <p className="text-sm text-zinc-500">{t('lipo.faqDesc')}</p>
                </div>
              </div>
              <div className="space-y-3">
                {faqs.map((faq, index) => (
                  <div key={index} className={`border rounded-2xl overflow-hidden transition-all duration-300 ${openFaq === index ? 'border-[#FE7623] shadow-lg shadow-orange-100 bg-white' : 'border-zinc-200 bg-white hover:border-zinc-300 hover:shadow-md'}`}>
                    <button className={`w-full flex items-center justify-between px-4 py-3 sm:px-6 sm:py-4 lg:py-5 text-left transition-colors gap-4 ${openFaq === index ? 'bg-gradient-to-r from-orange-50/50 to-white' : 'hover:bg-zinc-50/50'}`} onClick={() => toggleFaq(index)}>
                      <h4 className="text-sm sm:text-base text-zinc-800 font-medium flex-1">{faq.question}</h4>
                      <span className="flex-shrink-0 min-w-[32px] text-2xl sm:text-3xl font-light transition-all duration-300 text-[#FE7623]">{openFaq === index ? "−" : "+"}</span>
                    </button>
        ...
        <section className="py-8 md:py-20 px-6 bg-gradient-to-b from-zinc-50 to-white border-t border-zinc-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-row items-start gap-3 mb-10">
              ...
              <h3 className="text-sm font-bold text-[#FE7623] uppercase tracking-widest flex-1">{t('lipo.refTitle')}</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: t('lipo.harvardName'), url: "https://www.health.harvard.edu/", desc: t('lipo.harvardDesc'), color: "from-red-500 to-red-600" },
                { name: t('lipo.mayoName'), url: "https://www.mayoclinic.org/", desc: t('lipo.mayoDesc'), color: "from-blue-500 to-blue-600" },
                { name: t('lipo.pubmedName'), url: "https://pubmed.ncbi.nlm.nih.gov/", desc: t('lipo.pubmedDesc'), color: "from-green-500 to-green-600" }
              ].map((source, i) => (
        ...
        <section className="py-8 md:py-24 px-6 bg-white relative overflow-hidden">
          ...
          <div data-animate="cta" className={`max-w-3xl mx-auto text-center relative z-10 transition-all duration-700 ${isVisible('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h2 className="text-4xl font-semibold tracking-tight text-[#FE7623] mb-6 cursor-default">{t('lipo.ctaTitle')}</h2>
            <p className="text-lg text-zinc-500 mb-10 max-w-xl mx-auto">{t('lipo.ctaDesc')}</p>
